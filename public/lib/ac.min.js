/*
 ...
 Creation Time: 2022/12/21 6:36:04 PM
*/
...
$jscomp.defineProperty=$jscomp.ASSUME_ES5||"function"==typeof Object.defineProperties?Object.defineProperty:function(v,D,H){if(v==Array.prototype||v==Object.prototype)return v;v[D]=H.value;return v};$jscomp.getGlobal=function(v){v=["object"==typeof globalThis&&globalThis,v,"object"==typeof window&&window,"object"==typeof self&&self,"object"==typeof global&&global];for(var D=0;D<v.length;++D){var H=v[D];if(H&&H.Math==Math)return H}throw Error("Cannot find global object");};$jscomp.global=$jscomp.getGlobal(this);
$jscomp.IS_SYMBOL_NATIVE="function"===typeof Symbol&&"symbol"===typeof Symbol("x");$jscomp.TRUST_ES6_POLYFILLS=!$jscomp.ISOLATE_POLYFILLS||$jscomp.IS_SYMBOL_NATIVE;$jscomp.polyfills={};$jscomp.propertyToPolyfillSymbol={};$jscomp.POLYFILL_PREFIX="$jscp$";var $jscomp$lookupPolyfilledValue=function(v,D){var H=$jscomp.propertyToPolyfillSymbol[D];if(null==H)return v[D];H=v[H];return void 0!==H?H:v[D]};
$jscomp.polyfill=function(v,D,H,E){D&&($jscomp.ISOLATE_POLYFILLS?$jscomp.polyfillIsolated(v,D,H,E):$jscomp.polyfillUnisolated(v,D,H,E))};$jscomp.polyfillUnisolated=function(v,D,H,E){H=$jscomp.global;v=v.split(".");for(E=0;E<v.length-1;E++){var N=v[E];if(!(N in H))return;H=H[N]}v=v[v.length-1];E=H[v];D=D(E);D!=E&&null!=D&&$jscomp.defineProperty(H,v,{configurable:!0,writable:!0,value:D})};
$jscomp.polyfillIsolated=function(v,D,H,E){var N=v.split(".");v=1===N.length;E=N[0];E=!v&&E in $jscomp.polyfills?$jscomp.polyfills:$jscomp.global;for(var T=0;T<N.length-1;T++){var F=N[T];if(!(F in E))return;E=E[F]}N=N[N.length-1];H=$jscomp.IS_SYMBOL_NATIVE&&"es6"===H?E[N]:null;D=D(H);null!=D&&(v?$jscomp.defineProperty($jscomp.polyfills,N,{configurable:!0,writable:!0,value:D}):D!==H&&(void 0===$jscomp.propertyToPolyfillSymbol[N]&&(H=1E9*Math.random()>>>0,$jscomp.propertyToPolyfillSymbol[N]=$jscomp.IS_SYMBOL_NATIVE?
$jscomp.global.Symbol(N):$jscomp.POLYFILL_PREFIX+H+"$"+N),$jscomp.defineProperty(E,$jscomp.propertyToPolyfillSymbol[N],{configurable:!0,writable:!0,value:D})))};$jscomp.initSymbol=function(){};$jscomp.iteratorPrototype=function(v){v={next:v};v[Symbol.iterator]=function(){return this};return v};$jscomp.underscoreProtoCanBeSet=function(){var v={a:!0},D={};try{return D.__proto__=v,D.a}catch(H){}return!1};
...
$jscomp.generator.Context.prototype.yieldAll=function(v,D){v=$jscomp.makeIterator(v);var H=v.next();$jscomp.generator.ensureIteratorResultIsObject_(H);if(H.done)this.yieldResult=H.value,this.nextAddress=D;else return this.yieldAllIterator_=v,this.yield(H.value,D)};$jscomp.generator.Context.prototype.jumpTo=function(v){this.nextAddress=v};$jscomp.generator.Context.prototype.jumpToEnd=function(){this.nextAddress=0};
...
$jscomp.generator.Context.prototype.enterCatchBlock=function(v){this.catchAddress_=v||0;v=this.abruptCompletion_.exception;this.abruptCompletion_=null;return v};$jscomp.generator.Context.prototype.enterFinallyBlock=function(v,D,H){H?this.finallyContexts_[H]=this.abruptCompletion_:this.finallyContexts_=[this.abruptCompletion_];this.catchAddress_=v||0;this.finallyAddress_=D||0};
...
$jscomp.generator.Engine_.prototype.return_=function(v){this.context_.start_();var D=this.context_.yieldAllIterator_;if(D)return this.yieldAllStep_("return"in D?D["return"]:function(H){return{value:H,done:!0}},v,this.context_.return);this.context_.return(v);return this.nextStep_()};
...
$jscomp.asyncExecutePromiseGenerator=function(v){function D(E){return v.next(E)}function H(E){return v.throw(E)}return new Promise(function(E,N){function T(F){F.done?E(F.value):Promise.resolve(F.value).then(D,H).then(T,N)}T(v.next())})};$jscomp.asyncExecutePromiseGeneratorFunction=function(v){return $jscomp.asyncExecutePromiseGenerator(v())};$jscomp.asyncExecutePromiseGeneratorProgram=function(v){return $jscomp.asyncExecutePromiseGenerator(new $jscomp.generator.Generator_(new $jscomp.generator.Engine_(v)))};
$jscomp.polyfill("Array.prototype.includes",function(v){return v?v:function(D,H){var E=this;E instanceof String&&(E=String(E));var N=E.length;H=H||0;for(0>H&&(H=Math.max(H+N,0));H<N;H++){var T=E[H];if(T===D||Object.is(T,D))return!0}return!1}},"es7","es3");$jscomp.polyfill("Promise.prototype.finally",function(v){return v?v:function(D){return this.then(function(H){return Promise.resolve(D()).then(function(){return H})},function(H){return Promise.resolve(D()).then(function(){throw H;})})}},"es9","es3");
...
if(a instanceof Array)for(let c in a)b[c]=a[c].toString();else b=[a.toString()];return b}function W(a){switch(typeof a){case "undefined":return!0;case "string":if(0===a.replace(/(^[ \t\n\r]*)|([ \t\n\r]*$)/g,"").length)return!0;break;case "boolean":if(!a)return!0;break;case "number":if(isNaN(a))return!0;break;case "object":if(null===a||0===a.length)return!0;for(var b in a)return!1;return!0}return!1}function oa(a,b){for(a=a.toString();a.length<b;)a="0"+a;return a}function Ca(a){switch(a){case ca.StartingProcess:return"starting process...";
case ca.CheckingBusy:return"checking...";case ca.ProcessStartFailed:return"process start failed!";case ca.ProcessStarted:return"process started";case ca.LoadingProject:return"loading project...";case ca.ProjectLoaded:return"project loaded"}}function Da(a){return Q.isIOSDevice&&Q.isInWeixinBrowser?!1:a==ra.abnormal||a==ra.instance_disconnected}function Z(a,b){return void 0!==a&&null!==a?a:b}function ua(a){"string"===typeof a&&(a=document.getElementById(a));return a}function va(a){return a.keyCode===
da.Shift&&"ShiftRight"===a.code?da.RightShift:a.keyCode===da.Control&&"ControlRight"===a.code?da.RightControl:a.keyCode===da.Alt&&"AltRight"===a.code?da.RightAlt:a.keyCode}var p={None:0,Camera_PlayAnimation:1,Camera_StopAnimation:2,Misc_EnterReportMode:3,Misc_ExitReportMode:4,Misc_SetDateTime:5,Camera_GetCamera:6,Camera_SetState:7,Camera_Set:8,Camera_LookAtBBox:9,Coord_World2Screen:10,Coord_Screen2World:11,InfoTree_SetVisibility:12,InfoTree_Show:13,InfoTree_Hide:14,InfoTree_EnableXRay:15,InfoTree_DisableXRay:16,
...
"color",E(b),c)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",b,c)}}class eb extends P{constructor(a){super(a,"CameraTour")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}play(a,b){return this.int.call({command:p.CameraTour_Play,ids:K(a)},b)}pause(a){return this.int.call0(p.CameraTour_Pause,a)}resume(a){return this.int.call0(p.CameraTour_Resume,a)}stop(a){return this.int.call({command:p.CameraTour_Stop},a)}setUserData(a,
b,c){return super._updateOneProp(a,"userData",b,c)}setDuration(a,b,c){return super._updateOneProp(a,"duration",b,c)}setKeyFrames(a,b,c){return super._updateOneProp(a,"keyFrames",b,c)}setName(a,b,c){return super._updateOneProp(a,"name",b,c)}}class fb extends P{constructor(a){super(a,"Cesium3DTile")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,
b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}setTileURL(a,b,c){return super._updateOneProp(a,"tileURL",b,c)}}class gb extends P{constructor(a){super(a,"CustomMesh","color")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,
b)}get(a,b){return super._get(a,b)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",b,c)}setIndices(a,b,c){return super._updateOneProp(a,"indices",b,c)}setColor(a,b,c){return super._updateOneProp(a,"color",b,c)}}class hb extends P{constructor(a){super(a,"CustomObject")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,
b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}addByTileLayer(a,b){if(a instanceof Array)for(let c of a)this._fixTileLayerProperty(c);else this._fixTileLayerProperty(a);return this.int.call({command:p.CustomObject_AddByTileLayer,data:F(a)},b)}_fixTileLayerProperty(a){a.tileLayerId instanceof Array||(a.tileLayerId=F(a.tileLayerId));a.objectId instanceof Array||(a.objectId=F(a.objectId))}highlight(a,b){return this.int.call({command:p.CustomObject_Highlight,ids:K(a)},b)}unhighlight(a,
b){return"undefined"==typeof a||"function"==typeof a?("function"==typeof a&&(b=a),this.int.call({command:p.CustomObject_StopHighlight},b)):this.int.call({command:p.CustomObject_Unhighlight,ids:K(a)},b)}callFunction(a,b,c,e,d,h){return this.int.call({command:p.CustomObject_CallFunction,data:F({id:a.toString(),functionName:b,paramType:c,paramValue:e,parameters:d})},h)}callFunction4CustomObjectArr(a,b){return this.int.call({command:p.CustomObject_CallFunction,data:F(a)},b)}setLocation(a,b,c,e){return"function"==
typeof c?super._updateOneProp(a,"location",b,c):"number"==typeof c?this.int.call({command:p.CustomObject_Update,data:[{id:a,location:b,smoothTime:c}]},e):super._updateOneProp(a,"location",b,e)}setRotation(a,b,c){return super._updateOneProp(a,"rotation",b,c)}setLocalRotation(a,b,c){return super._updateOneProp(a,"localRotation",b,c)}setScale(a,b,c){return super._updateOneProp(a,"scale",b,c)}setSmoothMotion(a,b,c){return super._updateOneProp(a,"smoothMotion",b,c)}setTintColor(a,b,c){a={ids:F(a),color:E(b)};
return this.int.call({command:p.CustomObject_SetTintColor,data:F(a)},c)}overrideMaterial(a,b){return this.int.call({command:p.CustomObject_OverrideMaterial,data:F(a)},b)}restoreMaterial(a,b){return this.int.call({command:p.CustomObject_RestoreMaterial,ids:F(a)},b)}setViewportVisible(a,b,c){let e=[];e.push({viewportIndex:1,viewportVisible:!!(b&aa.V1)});e.push({viewportIndex:2,viewportVisible:!!(b&aa.V2)});e.push({viewportIndex:3,viewportVisible:!!(b&aa.V3)});e.push({viewportIndex:4,viewportVisible:!!(b&
aa.V4)});return this.int.call({command:p.CustomObject_SetViewportVisible,id:a,data:e},c)}startMove(a,b,c,e){return this.int.call({command:p.CustomObject_StartMove,id:a,coordinateType:b,data:F(c)},e)}stopMove(a,b){return this.int.call({command:p.CustomObject_StopMove,id:a},b)}}class ib extends P{constructor(a){super(a,"CustomTag")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,
b,c,e,d)}focusAll(a,b,c,e){return super._focusAll(a,b,c,e)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}setAutoHidePopupWindow(a,b,c){return super._updateOneProp(a,"autoHidePopupWindow",b,c)}}class jb extends P{constructor(a){super(a,"Decal")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,
b,c,e,d){return super._focus(a,b,c,e,d)}focusAll(a,b,c,e){return super._focusAll(a,b,c,e)}get(a,b){return super._get(a,b)}}class kb extends P{constructor(a){super(a,"DynamicWater")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}focusAll(a,b,c,e){return super._focusAll(a,b,c,e)}get(a,b){return super._get(a,b)}setCoordinates(a,b,c){return super._updateOneProp(a,
"coordinates",N(b),c)}setMaterialPath(a,b,c){return super._updateOneProp(a,"materialPath",b,c)}setStyle(a,b,c){return super._updateOneProp(a,"style",b,c)}}class lb extends P{constructor(a){super(a,"FloodFill","color")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,
b)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}setRange(a,b,c,e){b instanceof Array&&c instanceof Array?0<b.length&&0<c.length?this.update({id:a,min:b,max:c},e):console.error("\u6570\u7ec4\u53c2\u6570\u4e0d\u80fd\u4e3a\u7a7a."):console.error("\u6570\u7ec4\u53c2\u6570\u683c\u5f0f\u4e0d\u6b63\u786e.")}setMin(a,b,c){return super._updateOneProp(a,"min",b,c)}setMax(a,b,c){return super._updateOneProp(a,"max",b,c)}setSeed(a,b,c){return super._updateOneProp(a,"seed",b,c)}setElevation(a,
b,c){return super._updateOneProp(a,"elevation",b,c)}setColor(a,b,c){return super._updateOneProp(a,"color",E(b),c)}setPrecision(a,b,c){return super._updateOneProp(a,"precision",b,c)}}class mb extends P{constructor(a){super(a,"HeatMap")}_checkBBox(a){if(a instanceof Array){if(6!=a.length||a[0]>a[3]||a[1]>a[4]||a[2]>a[5])return!1}else return!1;return!0}add(a,b,c,e,d){return this._checkBBox(b)?this.int.call({command:p.HeatMap_Add,id:a.toString(),bbox:b,range:c,data:F(e)},d):(this.int.logWithColor("red",
"Invalid bbox value"),!1)}update(a,b,c,e,d){a={command:p.HeatMap_Update,id:a.toString()};if(b){if(!this._checkBBox(b))return this.int.logWithColor("red","Invalid bbox value"),!1;a.bbox=b}c&&(a.range=c);e&&(a.data=F(e));return this.int.call(a,d)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}addPoints(a,b,c){return this.int.call({command:p.HeatMap_AddPoints,
id:a,data:F(b)},c)}removePoints(a,b,c){return this.int.call({command:p.HeatMap_RemovePoints,id:a,pointIds:F(b)},c)}setRange(a,b,c){return this.int.call({command:p.HeatMap_Update,id:a,range:b},c)}setBBox(a,b,c){return this._checkBBox(b)?this.int.call({command:p.HeatMap_Update,id:a,bbox:b},c):(this.int.logWithColor("red","Invalid bbox value"),!1)}}class nb extends P{constructor(a){super(a,"HeatMap3D")}_checkBBox(a){if(a instanceof Array){if(6!=a.length||a[0]>a[3]||a[1]>a[4]||a[2]>a[5])return!1}else return!1;
return!0}add(a,b){return this.int.call({command:p.HeatMap3D_Add,data:F(a)},b)}update(a,b){return this.int.call({command:p.HeatMap3D_Update,data:F(a)},b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}setDisplayMode(a,b,c){return this.int.call({command:p.HeatMap3D_Update,id:a,displayMode:b},c)}}class ob extends P{constructor(a){super(a,
"HighlightArea","color")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}setColor(a,b,c){return super._updateOneProp(a,"color",E(b),c)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",b,c)}setHeightRange(a,b,c){return super._updateOneProp(a,"heightRange",
b,c)}setIntensity(a,b,c){return super._updateOneProp(a,"intensity",b,c)}setDepthTest(a,b,c){return super._updateOneProp(a,"depthTest",b,c)}}class pb extends P{constructor(a){super(a,"Light","color")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,
b){return super._get(a,b)}}class qb extends P{constructor(a){super(a,"Marker","fontColor|fontOutlineColor|textBackgroundColor|lineColor")}add(a,b){this._fixMarkerData(a);return super._add(a,b)}_fixMarkerProperty(a){a.textColor&&(a.fontColor=a.textColor);a.url&&(a.popupURL=a.url);a.dispalyMode&&(a.displayMode=a.dispalyMode);a.popupURL&&!a.popupSize&&(a.popupSize=[600,400]);0==a.showLine&&(a.lineSize=[0,0]);1!=a.showLine||null!=a.lineSize&&void 0!=a.lineSize||(a.lineSize=[2,100]);4==a.displayMode&&
0<a.autoDisplayModeSwitchFirstRatio&&0<a.autoDisplayModeSwitchSecondRatio&&(a.autoDisplayModeSwitchRatio=[a.autoDisplayModeSwitchFirstRatio,a.autoDisplayModeSwitchSecondRatio])}_fixMarkerData(a){if(a instanceof Array)for(let b of a)this._fixMarkerProperty(b);else this._fixMarkerProperty(a)}update(a,b){this._fixMarkerData(a);return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}focusAll(a,b,c,e){return super._focusAll(a,
b,c,e)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}showPopupWindow(a,b){return this.int.call({command:p.Marker_ShowPopupWindow,ids:K(a)},b)}hidePopupWindow(a,b){return this.int.call({command:p.Marker_HidePopupWindow,ids:K(a)},b)}showAllPopupWindow(a){return this.int.call0(p.Marker_ShowAllPopupWindow,a)}hideAllPopupWindow(a){return this.int.call0(p.Marker_HideAllPopupWindow,a)}get(a,b){return super._get(a,
b)}setGroupId(a,b,c){return super._updateOneProp(a,"groupId",b,c)}setUserData(a,b,c){return super._updateOneProp(a,"userData",b,c)}setAnchors(a,b,c){return this.setScreenOffset(a,b,c)}setScreenOffset(a,b,c){return super._updateOneProp(a,"anchors",b,c)}setCoordinate(a,b,c){return super._updateOneProp(a,"coordinate",b,c)}setImagePath(a,b,c){return super._updateOneProp(a,"imagePath",b,c)}setImageSize(a,b,c){return super._updateOneProp(a,"imageSize",b,c)}setHoverImagePath(a,b,c){return super._updateOneProp(a,
"hoverImagePath",b,c)}setURL(a,b,c){return super._updateOneProp(a,"url",b,c)}setText(a,b,c){return super._updateOneProp(a,"text",b,c)}setTextOffset(a,b,c){return super._updateOneProp(a,"textOffset",b,c)}setFontSize(a,b,c){return super._updateOneProp(a,"fontSize",b,c)}setFontOutlineSize(a,b,c){return super._updateOneProp(a,"fontOutlineSize",b,c)}setRange(a,b,c){return super._updateOneProp(a,"range",b,c)}setTextRange(a,b,c){return super._updateOneProp(a,"textRange",b,c)}setFontColor(a,b,c){return super._updateOneProp(a,
"fontColor",b,c)}setFontOutlineColor(a,b,c){return super._updateOneProp(a,"fontOutlineColor",b,c)}setTextBackgroundColor(a,b,c){return super._updateOneProp(a,"textBackgroundColor",b,c)}setAutoHidePopupWindow(a,b,c){return super._updateOneProp(a,"autoHidePopupWindow",b,c)}setPopupURL(a,b,c){return super._updateOneProp(a,"popupURL",b,c)}setPopupSize(a,b,c){return super._updateOneProp(a,"popupSize",b,c)}setPopupOffset(a,b,c){return super._updateOneProp(a,"popupOffset",b,c)}setLineSize(a,b,c){return super._updateOneProp(a,
"lineSize",b,c)}setLineColor(a,b,c){return super._updateOneProp(a,"lineColor",b,c)}setLineOffset(a,b,c){return super._updateOneProp(a,"lineOffset",b,c)}setPriority(a,b,c){return super._updateOneProp(a,"priority",b,c)}setOcclusionCull(a,b,c){return super._updateOneProp(a,"occlusionCull",b,c)}setAttachCustomObject(a,b){return this.int.call({command:p.Marker_SetupPOIAttachment,data:F(a)},b)}showByGroupId(a,b){return this.int.call({command:p.Marker_ShowByGroupId,ids:F(a)},b)}hideByGroupId(a,b){return this.int.call({command:p.Marker_HideByGroupId,
ids:F(a)},b)}deleteByGroupId(a,b){return this.int.call({command:p.Marker_DeleteByGroupId,ids:F(a)},b)}}class rb extends P{constructor(a){super(a,"Marker3D","textColor|textOutlineColor")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,
b){return super._get(a,b)}showByGroupId(a,b){return this.int.call({command:p.Marker3D_ShowByGroupId,groupId:a},b)}hideByGroupId(a,b){return this.int.call({command:p.Marker3D_HideByGroupId,groupId:a},b)}deleteByGroupId(a,b){return this.int.call({command:p.Marker3D_DeleteByGroupId,groupId:a},b)}}class sb extends P{constructor(a){super(a,"ODLine","color")}add(a,b){this._fixODlineData(a);return super._add(a,b)}_fixODlineProperty(a){a.intensity&&(a.brightness=a.intensity)}_fixODlineData(a){if(a instanceof
Array)for(let b of a)this._fixODlineProperty(b);else this._fixODlineProperty(a)}update(a,b){this._fixODlineData(a);return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",b,c)}setColor(a,
b,c){return super._updateOneProp(a,"color",E(b),c)}setFlowRate(a,b,c){return super._updateOneProp(a,"flowRate",b,c)}setBrightness(a,b,c){return super._updateOneProp(a,"brightness",b,c)}setTiling(a,b,c){return super._updateOneProp(a,"tiling",b,c)}setBendDegree(a,b,c){return super._updateOneProp(a,"bendDegree",b,c)}setLineThickness(a,b,c){return super._updateOneProp(a,"lineThickness",b,c)}setflowPointSizeScale(a,b,c){return super._updateOneProp(a,"flowPointSizeScale",b,c)}setLabelSizeScale(a,b,c){return super._updateOneProp(a,
"labelSizeScale",b,c)}setLineShape(a,b,c){return super._updateOneProp(a,"lineShape",b,c)}setLineStyle(a,b,c){return super._updateOneProp(a,"lineStyle",b,c)}setFlowShape(a,b,c){return super._updateOneProp(a,"flowShape",b,c)}setStartPointShape(a,b,c){return super._updateOneProp(a,"startPointShape",b,c)}setEndPointShape(a,b,c){return super._updateOneProp(a,"endPointShape",b,c)}setStartLabelShape(a,b,c){return super._updateOneProp(a,"startLabelShape",b,c)}setEndLabelShape(a,b,c){return super._updateOneProp(a,
"endLabelShape",b,c)}}class tb extends P{constructor(a){super(a,"Panorama")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}get(a,b){return super._get(a,b)}enter(a,b){return this.int.call({command:p.Panorama_Enter,ids:K(a)},b)}exit(a){return this.int.call({command:p.Panorama_Exit},a)}switchMode(a){return this.int.call({command:p.Panorama_Switch},a)}}class ub extends P{constructor(a){super(a,
"Polygon","color|frameColor")}add(a,b){this._fixPolygonData(a);return super._add(a,b)}_fixPolygonProperty(a){a.intensity&&(a.brightness=a.intensity)}_fixPolygonData(a){if(a instanceof Array)for(let b of a)this._fixPolygonProperty(b);else this._fixPolygonProperty(a)}update(a,b){this._fixPolygonData(a);return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,
b)}get(a,b){return super._get(a,b)}glow(a,b,c){return this.int.call({command:p.Polygon_Glow,ids:K(a),duration:b},c)}highlight(a,b){return this.int.call({command:p.Polygon_Highlight,ids:K(a)},b)}stopHighlight(a,b){return this.int.call({command:p.Polygon_StopHighlight,ids:K(a)},b)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",N(b),c)}setColor(a,b,c){return super._updateOneProp(a,"color",E(b),c)}setDepthTest(a,b,c){return super._updateOneProp(a,"depthTest",b,c)}}class vb extends P{constructor(a){super(a,
"Polygon3D","color")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}showAll(a){return super._showAll(a)}hideAll(a){return super._hideAll(a)}highlight(a,b){return this.int.call({command:p.Polygon3D_Highlight,ids:K(a)},b)}stopHighlight(a,b){return this.int.call({command:p.Polygon3D_StopHighlight,
ids:K(a)},b)}glow(a,b,c){return this.int.call({command:p.Polygon3D_Glow,ids:K(a),duration:b},c)}stopGlow(a,b){return this.int.call({command:p.Polygon3D_StopGlow,ids:K(a)},b)}setStyle(a,b,c){return super._updateOneProp(a,"style",b,c)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",b,c)}setColor(a,b,c){return super._updateOneProp(a,"color",E(b),c)}setHeight(a,b,c){return super._updateOneProp(a,"height",b,c)}setIntensity(a,b,c){return super._updateOneProp(a,"intensity",b,c)}setTillingX(a,
b,c){return super._updateOneProp(a,"tillingX",b,c)}setTillingY(a,b,c){return super._updateOneProp(a,"tillingY",b,c)}}class wb extends P{constructor(a){super(a,"Polyline","color")}add(a,b){this._fixPolylineData(a);return super._add(a,b)}_fixPolylineProperty(a){a.intensity&&(a.brightness=a.intensity)}_fixPolylineData(a){if(a instanceof Array)for(let b of a)this._fixPolylineProperty(b);else this._fixPolylineProperty(a)}update(a,b){this._fixPolylineData(a);return super._update(a,b)}delete(a,b){return super._delete(a,
b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}showAll(a){return super._showAll(a)}hide(a,b){return super._hide(a,b)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",b,c)}setStyle(a,b,c){return super._updateOneProp(a,"style",b,c)}setThickness(a,b,c){return super._updateOneProp(a,"thickness",b,c)}setColor(a,b,c){return super._updateOneProp(a,"color",
E(b),c)}setFlowRate(a,b,c){return super._updateOneProp(a,"flowRate",b,c)}setBrightness(a,b,c){return super._updateOneProp(a,"brightness",b,c)}setShape(a,b,c){return super._updateOneProp(a,"shape",b,c)}setDepth(a,b,c){return super._updateOneProp(a,"depthTest",b,c)}}class xb extends P{constructor(a){super(a,"RadiationPoint","color")}add(a,b){this._fixRadiationPointData(a);return super._add(a,b)}_fixRadiationPointProperty(a){a.intensity&&(a.brightness=a.intensity)}_fixRadiationPointData(a){if(a instanceof
Array)for(let b of a)this._fixRadiationPointProperty(b);else this._fixRadiationPointProperty(a)}update(a,b){this._fixRadiationPointData(a);return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}focusAll(a,b,c,e){return super._focusAll(a,b,c,e)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}showAll(a){return super._showAll(a)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,
b)}setCoordinate(a,b,c){return super._updateOneProp(a,"coordinate",b,c)}setRadius(a,b,c){return super._updateOneProp(a,"radius",b,c)}setRippleNumber(a,b,c){return super._updateOneProp(a,"rippleNumber",b,c)}setColor(a,b,c){return super._updateOneProp(a,"color",E(b),c)}setBrightness(a,b,c){return super._updateOneProp(a,"brightness",b,c)}setAutoHeight(a,b,c){return super._updateOneProp(a,"autoHeight",b,c)}}class yb extends P{constructor(a){super(a,"ShapeFileLayer","color")}add(a,b){return super._add(a,
b)}update(a,b){return super._update(a,b)}_fix_property(a){if(a instanceof Array){let b=[];for(let c of a)W(c.cacheAllField)&&(c.cacheAllField=!1,b.push(c));a=b}else W(a.cacheAllField)&&(a.cacheAllField=!1);return a}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}get(a,b){return super._get(a,b)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}showAll(a){return super._showAll(a)}hideAll(a){return super._hideAll(a)}open(a,
...
data:F(a)},b)}focusFeature(a,b,c,e,d,h){return this.int.call({command:p.ShapeFileLayer_FocusFeature,data:F({shpId:a,featureIds:[b]}),distance:c,flyTime:e,rotation:d},h)}getFeature(a,b){return this.int.call({command:p.ShapeFileLayer_GetFeatureInfo,data:F(a)},b)}}class zb extends P{constructor(a){super(a,"Tag","textColor|textBackgroundColor|textBorderColor")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,
...
b,c)}showPopupWindow(a,b){return this.int.call({command:p.Tag_PopupWindow_Show,ids:K(a)},b)}hidePopupWindow(a,b){return this.int.call({command:p.Tag_PopupWindow_Hide,ids:K(a)},b)}showAllPopupWindow(a){return this.int.call0(p.Tag_PopupWindow_ShowAll,a)}hideAllPopupWindow(a){return this.int.call0(p.Tag_PopupWindow_HideAll,a)}}class Ab extends P{constructor(a){super(a,"TileLayer")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}focus(a,b,c,
...
"rotation",b,c)}setScale(a,b,c){return super._updateOneProp(a,"scale",b,c)}showActor(a,b,c){a=new ea(a,b);return this.int.call({command:p.TileLayer_Actor_Show,data:F(a)},c)}showActors(a,b){let c=[];if(a instanceof Array)for(let d=0;d<a.length;d++){var e=a[d];e={tileLayerId:e.id,tileLayerActorNames:K(e.objectIds)};c.push(e)}else a={tileLayerId:a.id,tileLayerActorNames:K(a.objectIds)},c.push(a);return this.int.call({command:p.TileLayer_Actor_Show,data:c},b)}hideActor(a,b,c){a=new ea(a,b);return this.int.call({command:p.TileLayer_Actor_Hide,
data:F(a)},c)}hideActors(a,b){let c=[];if(a instanceof Array)for(let d=0;d<a.length;d++){var e=a[d];e={tileLayerId:e.id,tileLayerActorNames:K(e.objectIds)};c.push(e)}else a={tileLayerId:a.id,tileLayerActorNames:K(a.objectIds)},c.push(a);return this.int.call({command:p.TileLayer_Actor_Hide,data:c},b)}focusActor(a,b,c,e,d,h){a=new ea(a,b);return this.int.call({command:p.TileLayer_Actor_Focus,data:F(a),distance:c,flyTime:e,rotation:d},h)}focusActors(a,b,c,e,d){a=new ea(a.id,a.objectIds);return this.int.call({command:p.TileLayer_Actor_Focus,
data:F(a),distance:b,flyTime:c,rotation:e},d)}highlightActor(a,b,c){a=new ea(a,b);return this.int.call({command:p.TileLayer_Actor_Highlight,data:F(a)},c)}stopHighlightActor(a,b,c){let e=void 0==a;"function"==typeof a&&(c=a,e=!0);if(e)return this.stopHighlightActors(c);if(W(a)||W(b))console.error("\u53c2\u6570\u4e0d\u80fd\u4e3a\u7a7a!");else return this.stopHighlightActors({id:a,objectIds:[b]},c)}highlightActors(a,b){return this.int.call({command:p.TileLayer_Actor_Highlight,data:this._fix_highlight_actors_data(a)},
b)}stopHighlightActors(a,b){let c=!a;"function"==typeof a&&(b=a,c=!0);return c?this.int.call0(p.TileLayer_Actor_StopHightlight,b):this.int.call({command:p.TileLayer_Actor_Unhighlight,data:this._fix_highlight_actors_data(a)},b)}_fix_highlight_actors_data(a){if(W(a))console.error("\u53c2\u6570\u4e0d\u80fd\u4e3a\u7a7a!");else{var b=[];if(a instanceof Array)for(let c=0;c<a.length;c++){let e=new ea(a[c].id,a[c].objectIds);b.push(e)}else a=new ea(a.id,a.objectIds),b.push(a);return b}}stopHighlightAllActors(a){return this.int.call0(p.TileLayer_Actor_StopHightlight,
a)}showAllActors(a,b){return this.int.call({command:p.TileLayer_Actor_ShowAll,ids:K(a)},b)}hideAllActors(a,b){return this.int.call({command:p.TileLayer_Actor_HideAll,ids:K(a)},b)}setStyle(a,b,c,e,d,h,g,r){return this.int.call({command:p.TileLayer_SetStyle,ids:K(a),style:b,color:E(c),saturation:e,brightness:d,contrast:h,contrastbase:g},r)}setCollision(a,b,c,e,d,h){a=K(a);let g=[];for(let r of a)g.push({id:r,enableCollision:b,enableMouseRoma:c,enableFunctionInteract:e,enableCharacterCollision:d});return this.int.call({command:p.TileLayer_SetCollision,
data:g},h)}addModifiers(a,b){return this.int.call({command:p.TileLayer_Modifier_Add,data:F(a)},b)}addModifierByShapeFile(a,b){return this.int.call({command:p.TileLayer_Modifier_Add,data:F(a)},b)}addModifier(a,b,c,e,d){this.addModifiers([{id:a,tileLayerId:b,coordinates:c,ententBufferSize:e}])}updateModifier(a,b,c,e,d){return this.int.call({command:p.TileLayer_Modifier_Update,data:F([{id:a,tileLayerId:b,coordinates:c,ententBufferSize:e}])},d)}deleteModifier(a,b,c){return this.int.call({command:p.TileLayer_Modifier_Delete,
id:a,tileLayerId:b},c)}clearModifier(a,b){return this.int.call({command:p.TileLayer_Modifier_Clear,ids:K(a)},b)}setViewportVisible(a,b,c){let e=[];e.push({viewportIndex:1,viewportVisible:!!(b&aa.V1)});e.push({viewportIndex:2,viewportVisible:!!(b&aa.V2)});e.push({viewportIndex:3,viewportVisible:!!(b&aa.V3)});e.push({viewportIndex:4,viewportVisible:!!(b&aa.V4)});return this.int.call({command:p.TileLayer_SetViewportVisible,id:a,data:e},c)}getObjectIDs(a,b){return this.int.call({command:p.TileLayer_GetObjectIDs,
ids:K(a)},b)}getActorInfo(a,b){return this.int.call({command:p.TileLayer_Actor_GetInfo,data:F(a)},b)}addHoleByShapeFile(a,b){return this.int.call({command:p.TileLayer_CutPolygon_Add,data:F(a)},b)}addHole(a,b){return this.int.call({command:p.TileLayer_CutPolygon_Add,data:F(a)},b)}updateHole(a,b,c,e,d){return this.int.call({command:p.TileLayer_CutPolygon_Update,data:F({id:a,tileLayerId:b,coordinates:c,isReverseCut:e})},d)}deleteHole(a,b,c){return this.int.call({command:p.TileLayer_CutPolygon_Delete,
...
b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}setVideoURL(a,b,c){return super._updateOneProp(a,"videoURL",b,c)}setLocation(a,b,c){return super._updateOneProp(a,"location",b,c)}setRotation(a,b,c){return super._updateOneProp(a,"rotation",b,c)}setFovy(a,b,c){return super._updateOneProp(a,"fov",b,c)}setAspectRatio(a,b,c){return super._updateOneProp(a,"aspectRatio",b,c)}setDistance(a,b,c){return super._updateOneProp(a,"distance",b,c)}setDepthCulling(a,
b,c){return super._updateOneProp(a,"depthCulling",b,c)}setFrustumColor(a,b,c){return super._updateOneProp(a,"frustumColor",b,c)}}class Cb extends P{constructor(a){super(a,"WaterFlowField")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}}class Db extends P{constructor(a){super(a,
"WaterMesh","waterColor")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,b,c,e,d){return super._focus(a,b,c,e,d)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}showAll(a){return super._showAll(a)}hideAll(a){return super._hideAll(a)}get(a,b){return super._get(a,b)}setCoordinates(a,b,c){return super._updateOneProp(a,"coordinates",b,c)}setIndices(a,b,c){return super._updateOneProp(a,
"indices",b,c)}setNormals(a,b,c){return super._updateOneProp(a,"normals",b,c)}setWaterColor(a,b,c){return super._updateOneProp(a,"waterColor",b,c)}setWaterSpeed(a,b,c){return super._updateOneProp(a,"waterSpeed",b,c)}setWaterUVRepeat(a,b,c){return super._updateOneProp(a,"waterUVRepeat",b,c)}setWaterDirection(a,b,c){return super._updateOneProp(a,"waterDirection",b,c)}setWaterWaveScale(a,b,c){return super._updateOneProp(a,"waveScale",b,c)}}class Eb extends P{constructor(a){super(a,"ImageryLayer")}init(a,
b){return this.int.call({command:p.ImageryLayer_Init,xmlPath:a.xmlUrl,layerName:a.layerName,tileMatrixName:a.tileMatrixName,ogcEPSG:a.ogcEPSG,cachePath:a.cachePath,mapMode:a.mapMode,renderMode:a.renderMode},b)}add(a,b){const c=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){return a instanceof Array?new Promise(e=>$jscomp.asyncExecutePromiseGeneratorFunction(function*(){let d;for(let h of a)if(d=yield c.addOne(h,b),0!=d.result){e(d);break}e(d)})):c.addOne(a,b)})}addOne(a,b){return this.int.call({command:p.ImageryLayer_Add,
id:a.id,url:a.url},b)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}delete(a,b){return super._delete(a,b)}}class Fb extends P{constructor(a){super(a,"GeoJSONLayer")}load(a,b){return super._add(a,b)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}delete(a,b){return super._delete(a,b)}}class Gb extends P{constructor(a){super(a,"Vehicle")}add(a,b){return super._add(a,b)}update(a,b){return super._update(a,b)}delete(a,b){return super._delete(a,b)}clear(a){return super._clear(a)}focus(a,
b,c,e,d,h,g){return this.int.call({command:p.Vehicle_Focus,ids:F(a),distance:c,flyTime:e,rotation:d,distanceRotation:h,followEnabled:b},g)}show(a,b){return super._show(a,b)}hide(a,b){return super._hide(a,b)}get(a,b){return super._get(a,b)}setWayPoint(a,b){return this.int.call({command:p.Vehicle_AddWayPoints,data:F(a)},b)}start(a,b){if(W(a))console.error("\u53c2\u6570\u4e0d\u80fd\u4e3a\u7a7a!");else{if(0<=a.timeStamp)a.active=!0;else if(a instanceof Array)for(let c of a)c.active=!0;else{console.error("\u53c2\u6570\u975e\u6cd5!");
return}return this.int.call({command:p.Vehicle_Update,data:F(a)},b)}}pause(a,b){a=this._fixIds(a,!1);if(!W(a))return this.int.call({command:p.Vehicle_Update,data:a},b)}resume(a,b){a=this._fixIds(a,!0);if(!W(a))return this.int.call({command:p.Vehicle_Update,data:a},b)}stop(a,b){a=this._fixIds(a,!1);if(!W(a))return this.int.call({command:p.Vehicle_Update,data:a},b)}_fixIds(a,b){let c=[];if(W(a))console.error("\u53c2\u6570\u4e0d\u80fd\u4e3a\u7a7a!");else{if(a instanceof Array){let e=!1;for(let d of a){if("string"!=
typeof d){e=!0;break}c.push({id:d,active:b})}if(e){console.error("\u53c2\u6570\u975e\u6cd5!");return}return c}if("string"!==typeof a||W(a))console.error("\u53c2\u6570\u975e\u6cd5!");else return c.push({id:a,active:b}),c}}}class Hb{constructor(a){this.int=a;this._useOldDataFormat=!1}useOldDataFormat(a){this._useOldDataFormat=a||!0}get(a){return this.int.call0(p.Camera_GetCamera,a)}_setByArray(a,b,c){return this.set(a[0],a[1],a[2],a[3],a[4],b,c)}_setByObject(a,b,c){return this.set(a.x,a.y,a.z,a.pitch,
a.yaw,b,c)}set(a,b,c,e,d,h,g){if(a instanceof Array&&5<=a.length)return this._setByArray(a,b,c);if("object"==typeof a&&a.hasOwnProperty("x"))return this._setByObject(a,b,c);"function"==typeof h&&(g=h,h=void 0);if(this._useOldDataFormat){let r=e;e=d;d=r}return this.int.call({command:p.Camera_Set,coordinate:[a,b,c],pitch:e||0,yaw:d||0,flyTime:h},g)}lookAt(a,b,c,e,d,h,g,r){"function"==typeof g&&(r=g,g=void 0);if(this._useOldDataFormat){let k=d;d=h;h=k}return this.int.call({command:p.Camera_Set,coordinate:[a,
b,c],distance:e,pitch:d||0,yaw:h||0,flyTime:g},r)}lookAtBBox(a,b,c,e,d){"function"==typeof e&&(d=e,e=void 0);if(this._useOldDataFormat){let h=b;b=c;c=h}return this.int.call({command:p.Camera_LookAtBBox,bbox:a,pitch:b||0,yaw:c||0,flyTime:e},d)}playAnimation(a,b){return this.int.call({command:p.Camera_PlayAnimation,id:a},b)}stopAnimation(a){return this.int.call0(p.Camera_StopAnimation,a)}pauseAnimation(a){return this.int.call0(p.Camera_PauseAnimation,a)}resumeAnimation(a){return this.int.call0(p.Camera_ResumeAnimation,
...
a[1];return[Math.atan2(b[2]-a[2],Math.sqrt(e*e+d*d))*c,Math.atan2(e,d)*c-90,0]}lockByBBox(a,b){return this.int.call({command:p.Camera_LockBBox,bbox:a},b)}unlock(a){return this.int.call({command:p.Camera_UnLockBBox},a)}exitWorld(a,b,c){return this.int.call({command:p.Camera_ExitEarthCapture,coordinate:a,rotation:b},c)}enterWorld(a){return this.int.call({command:p.Camera_EnterEarthCapture},a)}}class Ib{constructor(a){this.int=a}screen2World(a,b,c){return this.int.call({command:p.Coord_Screen2World,
screenPosition:[a,b]},c)}world2Screen(a,b,c,e){return this.int.call({command:p.Coord_World2Screen,worldlocation:[a,b,c]},e)}gcs2pcs(a,b){return this.int.call({command:p.Coord_GCS2PCS,coordinates:T(a)},b)}pcs2gcs(a,b){return this.int.call({command:p.Coord_PCS2GCS,coordinates:T(a)},b)}}class Jb{constructor(a){this.int=a}start(a){return this.int.call0(p.EditHelper_Start,a)}cancel(a){return this.int.call0(p.EditHelper_Quit,a)}finish(a,b){return this.int.call({command:p.EditHelper_Finish,withOffset:a||
!0},b)}setParam(a,b,c,e){return this.int.call({command:p.EditHelper_SetParam,lineType:a,buildType:b,color:E(c)},e)}}class Kb{constructor(a){this.int=a}setVisibility(a,b){return this.int.call({command:p.InfoTree_SetVisibility,layers:F(a)},b)}show(a,b){return this.int.call({command:p.InfoTree_Show,ids:K(a)},b)}hide(a,b){return this.int.call({command:p.InfoTree_Hide,ids:K(a)},b)}enableXRay(a,b,c){return this.int.call({command:p.InfoTree_EnableXRay,ids:F(a),color:E(b)},c)}disableXRay(a,b){return this.int.call({command:p.InfoTree_DisableXRay,
ids:F(a)},b)}showByGroupId(a,b){return this.int.call({command:p.InfoTree_ShowByGroupId,ids:K(a)},b)}hideByGroupId(a,b){return this.int.call({command:p.InfoTree_HideByGroupId,ids:K(a)},b)}highlightByGroupId(a,b){return this.int.call({command:p.InfoTree_HighlightByGroupId,ids:K(a)},b)}deleteByGroupId(a,b){return this.int.call({command:p.InfoTree_DeleteByGroupId,ids:K(a)},b)}get(a){return this.int.call0(p.InfoTree_Get,a)}focus(a,b){return this.int.call({command:p.InfoTree_Focus,ids:K(a)},b)}}class Lb{constructor(a){this.int=
a;this.apiVersion="5.3";this.apiVersionServer=""}isApiVersionMatched(){return"5.3"==this.apiVersionServer}addImageButtons(a,b){return this.int.call({command:p.Misc_AddImageButton,data:F(a)},b)}deleteImageButtons(a,b){return this.int.call({command:p.Misc_DeleteImageButton,ids:K(a)},b)}addAnimatedImageButtons(a,b){return this.int.call({command:p.Misc_AddAnimatedImageButton,data:F(a)},b)}setApiVersionReceived(a){this.int.onApiVersionReceived=a}playVideo(a,b,c,e,d,h,g){return this.int.call({command:p.Misc_PlayVideo,
data:[{id:a.toString(),position:[b,c],size:[e,d],url:h}]},g)}stopPlayVideo(a,b){return this.int.call({command:p.Misc_StopPlayVideo,ids:K(a)},b)}playMovie(a,b,c){"function"==typeof b&&(c=b,b=!1);return this.int.call({command:p.Misc_PlayMovie,loop:b,url:a},c)}stopMovie(a){return this.int.call({command:p.Misc_StopMovie},a)}setWindowResolution(a,b,c){return this.int.call({command:p.Misc_SetWindowResolution,cx:a,cy:b,mode:0},c)}callBPFunction(a,b){return this.int.call({command:p.Misc_CallBPFunction,data:F(a)},
b)}enterReportMode(a){return this.int.call0(p.Misc_EnterReportMode)}exitReportMode(a){return this.int.call0(p.Misc_ExitReportMode,a)}showAllFoliages(a){return this.int.call0(p.Misc_ShowAllFoliages,a)}hideAllFoliages(a){return this.int.call0(p.Misc_HideAllFoliages,a)}startProcess(a,b,c,e){"function"==typeof c&&(e=c,c=!0);return this.int.call({command:p.Misc_StartProcess,appName:a,commandLine:b,visible:c},e)}enterMultiViewportMode(a,b,c,e){if(null==b||void 0==b)b="#DEA309";if(null==c||void 0==c)c=2;
return this.int.call({command:p.Misc_EnterMultiViewport,type:a,lineColor:E(b),lineThickness:c},e)}exitMultiViewportMode(a){return this.int.call({command:p.Misc_ExitMultiViewport},a)}setActiveViewport(a,b){return this.int.call({command:p.Misc_SetActivateMultiViewport,viewIndex:F(a)},b)}getActiveViewport(a){return this.int.call({command:p.Misc_GetActivateMultiViewport},a)}setMultiviewportInteractSync(a,b){this.setCameraFollow4Viewport(a,b)}setCameraFollow4Viewport(a,b){return this.int.call({command:p.Misc_UpdateMultiViewport,
...
a)}removeLabelLayer(a){return this.int.call({command:p.VTPKService_Set,vtpk:""},a)}setRenderedCursorVisible(a,b){this.setCursorAutoSync(a,b)}setCursorAutoSync(a,b){return this.int.call({command:p.Settings_CursorAutoSync,useSoftwareCursor:a},b)}}class Nb{constructor(a){this.int=a}setReportMode(a,b,c,e){return this.int.call({command:p.Settings_SetReport,alignment:a,playMode:b,moveInOtherView:c},e)}getReportMode(a){return this.int.call({command:p.Settings_GetReport},a)}setControlMode(a,b,c,e,d){return this.int.call({command:p.Settings_SetControl,
speed:a,yawSpeed:b,rotateSelf:c,useFemale:e},d)}getControlMode(a){return this.int.call({command:p.Settings_GetControl},a)}setPostProcessMode(a,b){let c,e;if(0<=a.terrainGlobalAlpha&&1>=a.terrainGlobalAlpha){c=100*a.terrainGlobalAlpha;if(0<=a.osgbGlobalAlpha&&1>=a.osgbGlobalAlpha)return e=100*a.osgbGlobalAlpha,this.int.call({command:p.Settings_SetPostProcess,contrast:a.contrast,saturation:a.saturation,lensFlareIntensity:a.lensFlareIntensity,ambientIntensity:a.ambientIntensity,bloomIntensity:a.bloomIntensity,
lutMode:a.lutMode,lutIntensity:a.lutIntensity,darkCorner:a.darkCorner,screenPercentage:a.screenPercentage,terrainGlobalAlpha:c,terrainGlobalLitStatus:a.terrainGlobalLitStatus,osgbGlobalLitStatus:a.osgbGlobalLitStatus,osgbGlobalAlpha:e,antiAliasing:a.antiAliasing,tonemapper:a.tonemapper,postProcessEffects:a.postProcessEffects,dofMode:a.dofMode,wireThickness:a.wireThickness,receiveDecalMode:a.receiveDecalMode},b);console.error("osgbGlobalAlpha\u53c2\u6570\u975e\u6cd5")}else console.error("terrainGlobalAlpha\u53c2\u6570\u975e\u6cd5")}getPostProcessMode(a){return this.int.call({command:p.Settings_GetPostProcess},
...
groundHeight:b.groundHeight||0,renderMode:b.renderMode||0,serverURL:b.serverURL,coordOrder:b.coordOrder,maxLevel:b.maxLevel},c)}getMapMode(a){return this.int.call0(p.Settings_GetMapMode,a)}}class Ob{constructor(a){this.int=a}startPolygonClip(a,b,c){return this.int.call({command:p.Tools_StartPolygonClip,data:F({id:"0",coordinates:N(a),toggleImageCut:b})},c)}startPlaneClip(a,b,c,e,d){return this.int.call({command:p.Tools_StartPlaneClip,location:a,rotation:b,isShowPlane:c,isEdit:e},d)}startVolumeClip(a,
...
else{if(a.startHour==a.endHour){if(a.startMinute==a.endMinute){console.error("\u5f00\u59cb\u65f6\u95f4\u4e0d\u80fd\u7b49\u4e8e\u7ed3\u675f\u65f6\u95f4");return}if(a.startMinute>a.endMinute){console.error("\u5f00\u59cb\u65f6\u95f4\u4e0d\u80fd\u5927\u4e8e\u7ed3\u675f\u65f6\u95f4");return}}W(a.groundElevation)||(c=a.groundElevation,!isNaN(parseFloat(c))&&isFinite(c)&&(a.undersideHeight=a.groundElevation,delete a.groundElevation));a.command=p.Tools_StartSunshineAnalysis;return this.int.call(a,b)}else console.error("\u53c2\u6570endTime\u65f6\u95f4\u683c\u5f0f\u4e0d\u6b63\u786e");
...
this.websocket.onerror=a=>this.onConnectionError(a)}}setEventCallback(a){this.options.onEvent=a}destroy(){this.isDestroyed=!0;this.player&&this.player.destroy();this.websocket&&(this.websocket.close(),this.websocket=null)}reset(a){return this.call0(p.Reset,a)}saveProject(a){return this.call0(p.SaveProject,a)}registerTick(a,b){this.removeTick();a={id:this.tickMarkerId,coordinate:[0,0,0],popupURL:a,popupSize:[4,4],autoHidePopupWindow:!1,displayMode:2,priority:0,occlusionCull:!1};b&&(a.coordinate=[495269,
2491073,25],a.coordinateType=0,a.range=[1,1E5],a.text="TickMarker",a.textRange=[1,1E5],a.popupSize=[200,200],a.showLine=!0);this.marker.add(a,c=>this.marker.showPopupWindow(this.tickMarkerId))}removeTick(){this.marker.hidePopupWindow(this.tickMarkerId)}getVersion(){return"5.3.1221"}initInterface(){this.camera=new Hb(this);this.coord=new Ib(this);this.layers=this.infoTree=new Kb(this);this.ct=this.cameraTour=new eb(this);this.tl=this.tileLayer=new Ab(this);this.tag=new zb(this);this.marker=new qb(this);
this.marker3d=new rb(this);this.ctag=this.customTag=new ib(this);this.rp=this.radiationPoint=new xb(this);this.cm=this.customMesh=new gb(this);this.wm=this.waterMesh=new Db(this);this.waterFlowField=new Cb(this);this.wff=this.WaterFlowField;this.line=this.polyline=new wb(this);this.ol=this.odline=new sb(this);this.p3d=this.polygon3d=new vb(this);this.polygon=new ub(this);this.hm=this.heatmap=new mb(this);this.hm3d=this.heatmap3d=new nb(this);this.beam=new db(this);this.ha=this.highlightArea=new ob(this);
this.co=this.customObject=new hb(this);this.vp=this.videoProjection=new Bb(this);this.panorama=new tb(this);this.decal=new jb(this);this.dw=this.dynamicWater=new kb(this);this.ff=this.floodFill=new lb(this);this.c3d=this.cesium3DTileset=new fb(this);this.shapeFile=this.shp=this.shapeFileLayer=new yb(this);this.light=new pb(this);this.imagery=this.imageryLayer=new Eb(this);this.geoJSON=this.geoJSONLayer=new Fb(this);this.vc=this.vehicle=new Gb(this);this.misc=new Lb(this);this.tools=new Ob(this);this.settings=
new Mb(this);this.weather=new Pb(this);this.eh=this.editHelper=new Jb(this);this.sp=this.settingsPanel=new Nb(this)}_getCallbackIndex(){return++this.callbackIndex}call0(a,b){return this.call({command:a},b)}call(a,b){if(!this.isConnected)return this.logWithColor("red","Not connected!"),b?void 0:Promise.reject("Not connected!");if(void 0==a.command||a.command==p.None)return this.logWithColor("red","command is undefined or None"),b?void 0:Promise.reject("command is undefined or None");a.timestamp=Date.now();
a.callbackIndex=this._getCallbackIndex();a.__command=p[a.command]||"Unknown";a.__version=this.getVersion();null===b&&(a.__noResponse=!0);let c=a.command+"_"+a.callbackIndex;b&&"function"==typeof b&&(this.callbackMap[c]=b);let e=JSON.stringify(a);this.log("");this.logWithColor("RoyalBlue",`Request: ${p[a.command]||"Unknown"}`,!0);this.logWithColor("green","\uff08"+(new Date(a.timestamp)).toLocaleTimeString()+"\uff09");this.logWithColor("gray",`${e}`);if(b||null===b)this.apiQueue.push(a);else return new Promise(d=>
{this.callbackMap[c]=d;this.apiQueue.push(a)})}sendAPI(a){a&&(this.isCalledInCEF?ue.dtspoi.execute(JSON.stringify(a)):this.player?this.player.rtc&&this.player.rtc.sendAPI(a):this.sendStringByWS(JSON.stringify(a)))}sendStringByWS(a){let b=a.length;if(16777216>=b)this.websocket.send(a);else{var c=Math.ceil(b/16777216),e=[];for(let d=0;d<c;d++)e[d]=(0==d?"__MI_SECTION_START__":d==c-1?"__MI_SECTION_END__":"__MI_SECTION__")+a.substr(16777216*d,d==c-1?b-16777216*d:16777216);for(let d of e)this.websocket.send(d)}}viewHome(a){switch(a){case 0:this.savedCamera?
...
this.removeEventListener("track",this._ontrack);this.addEventListener("track",this._ontrack=t)},enumerable:!0,configurable:!0});var l=f.RTCPeerConnection.prototype.setRemoteDescription;f.RTCPeerConnection.prototype.setRemoteDescription=function(){var t=this;this._ontrackpoly||(this._ontrackpoly=function(w){w.stream.addEventListener("addtrack",function(q){var y=void 0;y=f.RTCPeerConnection.prototype.getReceivers?t.getReceivers().find(function(A){return A.track&&A.track.id===q.track.id}):{track:q.track};
var u=new Event("track");u.track=q.track;u.receiver=y;u.transceiver={receiver:y};u.streams=[w.stream];t.dispatchEvent(u)});w.stream.getTracks().forEach(function(q){var y=void 0;y=f.RTCPeerConnection.prototype.getReceivers?t.getReceivers().find(function(A){return A.track&&A.track.id===q.id}):{track:q};var u=new Event("track");u.track=q;u.receiver=y;u.transceiver={receiver:y};u.streams=[w.stream];t.dispatchEvent(u)})},this.addEventListener("addstream",this._ontrackpoly));return l.apply(this,arguments)}}};
...
f.RTCPeerConnection.prototype.getStats;f.RTCPeerConnection.prototype.getStats=function(){var t=this,w=Array.prototype.slice.call(arguments),q=w[0],y=w[1];w=w[2];if(0<arguments.length&&"function"===typeof q)return l.apply(this,arguments);if(0===l.length&&(0===arguments.length||"function"!==typeof q))return l.apply(this,[]);var u=function(m){var n={};m.result().forEach(function(x){var z={id:x.id,timestamp:x.timestamp,type:{localcandidate:"local-candidate",remotecandidate:"remote-candidate"}[x.type]||
x.type};x.names().forEach(function(B){z[B]=x.stat(B)});n[z.id]=z});return n},A=function(m){return new Map(Object.keys(m).map(function(n){return[n,m[n]]}))};return 2<=arguments.length?l.apply(this,[function(m){y(A(u(m)))},q]):(new Promise(function(m,n){l.apply(t,[function(x){m(A(u(x)))},n])})).then(y,w)}}};c.shimSenderReceiverGetStats=function(f){if("object"===("undefined"===typeof f?"undefined":h(f))&&f.RTCPeerConnection&&f.RTCRtpSender&&f.RTCRtpReceiver){if(!("getStats"in f.RTCRtpSender.prototype)){var l=
f.RTCPeerConnection.prototype.getSenders;l&&(f.RTCPeerConnection.prototype.getSenders=function(){var y=this,u=l.apply(this,[]);u.forEach(function(A){return A._pc=y});return u});var t=f.RTCPeerConnection.prototype.addTrack;t&&(f.RTCPeerConnection.prototype.addTrack=function(){var y=t.apply(this,arguments);y._pc=this;return y});f.RTCRtpSender.prototype.getStats=function(){var y=this;return this._pc.getStats().then(function(u){return k.filterStats(u,y.track,!0)})}}if(!("getStats"in f.RTCRtpReceiver.prototype)){var w=
f.RTCPeerConnection.prototype.getReceivers;w&&(f.RTCPeerConnection.prototype.getReceivers=function(){var y=this,u=w.apply(this,[]);u.forEach(function(A){return A._pc=y});return u});k.wrapPeerConnectionEvent(f,"track",function(y){y.receiver._pc=y.srcElement;return y});f.RTCRtpReceiver.prototype.getStats=function(){var y=this;return this._pc.getStats().then(function(u){return k.filterStats(u,y.track,!1)})}}if("getStats"in f.RTCRtpSender.prototype&&"getStats"in f.RTCRtpReceiver.prototype){var q=f.RTCPeerConnection.prototype.getStats;
...
ScreenCaptureError:"AbortError",DeviceCaptureError:"AbortError"}[q.name]||q.name,message:q.message,constraint:q.constraint||q.constraintName,toString:function(){return this.name+(this.message&&": ")+this.message}}};r.getUserMedia=function(q,y,u){l(q,function(A){r.webkitGetUserMedia(A,y,function(m){u&&u(t(m))})})}.bind(r);if(r.mediaDevices.getUserMedia){var w=r.mediaDevices.getUserMedia.bind(r.mediaDevices);r.mediaDevices.getUserMedia=function(q){return l(q,function(y){return w(y).then(function(u){if(y.audio&&
...
{get:function(){return u}});this._sctp=y}return w.apply(this,arguments)}}};c.shimSendThrowTypeError=function(g){function r(f,l){var t=f.send;f.send=function(){var w=arguments[0];w=w.length||w.size||w.byteLength;if("open"===f.readyState&&l.sctp&&w>l.sctp.maxMessageSize)throw new TypeError("Message too large (can send a maximum of "+l.sctp.maxMessageSize+" bytes)");return t.apply(f,arguments)}}if(g.RTCPeerConnection&&"createDataChannel"in g.RTCPeerConnection.prototype){var k=g.RTCPeerConnection.prototype.createDataChannel;
...
r[k]=function(){this._connectionstatechangepoly||(this._connectionstatechangepoly=function(l){var t=l.target;if(t._lastConnectionState!==t.connectionState){t._lastConnectionState=t.connectionState;var w=new Event("connectionstatechange",l);t.dispatchEvent(w)}return l},this.addEventListener("iceconnectionstatechange",this._connectionstatechangepoly));return f.apply(this,arguments)}})}};c.removeAllowExtmapMixed=function(g){if(g.RTCPeerConnection){var r=h.detectBrowser(g);if(!("chrome"===r.browser&&
...
function(){var q=Array.prototype.slice.call(arguments),y=q[1],u=q[2];return w.apply(this,[q[0]||null]).then(function(A){if(53>f.version&&!y)try{A.forEach(function(m){m.type=t[m.type]||m.type})}catch(m){if("TypeError"!==m.name)throw m;A.forEach(function(n,x){A.set(x,Object.assign({},n,{type:t[n.type]||n.type}))})}return A}).then(y,u)}}};c.shimSenderGetStats=function(k){if("object"===("undefined"===typeof k?"undefined":d(k))&&k.RTCPeerConnection&&k.RTCRtpSender&&!(k.RTCRtpSender&&"getStats"in k.RTCRtpSender.prototype)){var f=
k.RTCPeerConnection.prototype.getSenders;f&&(k.RTCPeerConnection.prototype.getSenders=function(){var t=this,w=f.apply(this,[]);w.forEach(function(q){return q._pc=t});return w});var l=k.RTCPeerConnection.prototype.addTrack;l&&(k.RTCPeerConnection.prototype.addTrack=function(){var t=l.apply(this,arguments);t._pc=this;return t});k.RTCRtpSender.prototype.getStats=function(){return this.track?this._pc.getStats(this.track):Promise.resolve(new Map)}}};c.shimReceiverGetStats=function(k){if("object"===("undefined"===
typeof k?"undefined":d(k))&&k.RTCPeerConnection&&k.RTCRtpSender&&!(k.RTCRtpSender&&"getStats"in k.RTCRtpReceiver.prototype)){var f=k.RTCPeerConnection.prototype.getReceivers;f&&(k.RTCPeerConnection.prototype.getReceivers=function(){var l=this,t=f.apply(this,[]);t.forEach(function(w){return w._pc=l});return t});r.wrapPeerConnectionEvent(k,"track",function(l){l.receiver._pc=l.srcElement;return l});k.RTCRtpReceiver.prototype.getStats=function(){return this._pc.getStats(this.track)}}};c.shimRemoveStream=
...
});var w=f.apply(this,arguments);if(t){var q=w.sender;t=q.getParameters();"encodings"in t||(t.encodings=l.sendEncodings,q.sendEncodings=l.sendEncodings,this.setParametersPromises.push(q.setParameters(t).then(function(){delete q.sendEncodings}).catch(function(){delete q.sendEncodings})))}return w})}};c.shimGetParameters=function(k){if("object"===("undefined"===typeof k?"undefined":d(k))&&k.RTCRtpSender){var f=k.RTCRtpSender.prototype.getParameters;f&&(k.RTCRtpSender.prototype.getParameters=function(){var l=
...
r=h&&h.navigator;h=h&&h.MediaStreamTrack;r.getUserMedia=function(w,q,y){d.deprecated("navigator.getUserMedia","navigator.mediaDevices.getUserMedia");r.mediaDevices.getUserMedia(w).then(q,y)};if(!(55<g.version&&"autoGainControl"in r.mediaDevices.getSupportedConstraints())){var k=function(w,q,y){q in w&&!(y in w)&&(w[y]=w[q],delete w[q])},f=r.mediaDevices.getUserMedia.bind(r.mediaDevices);r.mediaDevices.getUserMedia=function(w){"object"===("undefined"===typeof w?"undefined":e(w))&&"object"===e(w.audio)&&
...
f=g.setLocalDescription,l=g.setRemoteDescription,t=g.addIceCandidate;g.createOffer=function(q,y){var u=r.apply(this,[2<=arguments.length?arguments[2]:arguments[0]]);if(!y)return u;u.then(q,y);return Promise.resolve()};g.createAnswer=function(q,y){var u=k.apply(this,[2<=arguments.length?arguments[2]:arguments[0]]);if(!y)return u;u.then(q,y);return Promise.resolve()};var w=function(q,y,u){q=f.apply(this,[q]);if(!u)return q;q.then(y,u);return Promise.resolve()};g.setLocalDescription=w;w=function(q,y,
u){q=l.apply(this,[q]);if(!u)return q;q.then(y,u);return Promise.resolve()};g.setRemoteDescription=w;w=function(q,y,u){q=t.apply(this,[q]);if(!u)return q;q.then(y,u);return Promise.resolve()};g.addIceCandidate=w}};c.shimGetUserMedia=function(g){var r=g&&g.navigator;if(r.mediaDevices&&r.mediaDevices.getUserMedia){g=r.mediaDevices;var k=g.getUserMedia.bind(g);r.mediaDevices.getUserMedia=function(f){return k(e(f))}}!r.getUserMedia&&r.mediaDevices&&r.mediaDevices.getUserMedia&&(r.getUserMedia=function(f,
l,t){r.mediaDevices.getUserMedia(f).then(l,t)}.bind(r))};c.shimConstraints=e;c.shimRTCIceServerUrls=function(g){var r=g.RTCPeerConnection;g.RTCPeerConnection=function(k,f){if(k&&k.iceServers){for(var l=[],t=0;t<k.iceServers.length;t++){var w=k.iceServers[t];!w.hasOwnProperty("urls")&&w.hasOwnProperty("url")?(h.deprecated("RTCIceServer.url","RTCIceServer.urls"),w=JSON.parse(JSON.stringify(w)),w.urls=w.url,delete w.url,l.push(w)):l.push(k.iceServers[t])}k.iceServers=l}return new r(k,f)};g.RTCPeerConnection.prototype=
...
f:Object.keys(f).reduce(function(l,t){var w="[object Object]"===Object.prototype.toString.call(f[t]),q=w?d(f[t]):f[t];w=w&&!Object.keys(q).length;if(void 0===q||w)return l;w=Object;var y=w.assign,u={};t in u?Object.defineProperty(u,t,{value:q,enumerable:!0,configurable:!0,writable:!0}):u[t]=q;return y.call(w,l,u)},{})}function h(f,l,t){l&&!t.has(l.id)&&(t.set(l.id,l),Object.keys(l).forEach(function(w){w.endsWith("Id")?h(f,f.get(l[w]),t):w.endsWith("Ids")&&l[w].forEach(function(q){h(f,f.get(q),t)})}))}
...
w&&A.trackId===u.id&&h(f,A,q)})});return q};var r=!0,k=!0},{}],16:[function(a,b,c){function e(l,t,w,q,y){t=f.writeRtpDescription(l.kind,t);t+=f.writeIceParameters(l.iceGatherer.getLocalParameters());t+=f.writeDtlsParameters(l.dtlsTransport.getLocalParameters(),"offer"===w?"actpass":y||"active");t+="a=mid:"+l.mid+"\r\n";t=l.rtpSender&&l.rtpReceiver?t+"a=sendrecv\r\n":l.rtpSender?t+"a=sendonly\r\n":l.rtpReceiver?t+"a=recvonly\r\n":t+"a=inactive\r\n";l.rtpSender&&(w=l.rtpSender._initialTrackId||l.rtpSender.track.id,
l.rtpSender._initialTrackId=w,q="msid:"+(q?q.id:"-")+" "+w+"\r\n",t=t+("a="+q)+("a=ssrc:"+l.sendEncodingParameters[0].ssrc+" "+q),l.sendEncodingParameters[0].rtx&&(t+="a=ssrc:"+l.sendEncodingParameters[0].rtx.ssrc+" "+q,t+="a=ssrc-group:FID "+l.sendEncodingParameters[0].ssrc+" "+l.sendEncodingParameters[0].rtx.ssrc+"\r\n"));t+="a=ssrc:"+l.sendEncodingParameters[0].ssrc+" cname:"+f.localCName+"\r\n";l.rtpSender&&l.sendEncodingParameters[0].rtx&&(t+="a=ssrc:"+l.sendEncodingParameters[0].rtx.ssrc+" cname:"+
f.localCName+"\r\n");return t}function d(l,t){var w=!1;l=JSON.parse(JSON.stringify(l));return l.filter(function(q){if(q&&(q.urls||q.url)){var y=q.urls||q.url;q.url&&!q.urls&&console.warn("RTCIceServer.url is deprecated! Use urls instead.");var u="string"===typeof y;u&&(y=[y]);y=y.filter(function(A){return 0!==A.indexOf("turn:")||-1===A.indexOf("transport=udp")||-1!==A.indexOf("turn:[")||w?0===A.indexOf("stun:")&&14393<=t&&-1===A.indexOf("?transport=udp"):w=!0});delete q.url;q.urls=u?y[0]:y;return!!y.length}})}
function h(l,t){var w={codecs:[],headerExtensions:[],fecMechanisms:[]},q=function(u,A){u=parseInt(u,10);for(var m=0;m<A.length;m++)if(A[m].payloadType===u||A[m].preferredPayloadType===u)return A[m]},y=function(u,A,m,n){u=q(u.parameters.apt,m);A=q(A.parameters.apt,n);return u&&A&&u.name.toLowerCase()===A.name.toLowerCase()};l.codecs.forEach(function(u){for(var A=0;A<t.codecs.length;A++){var m=t.codecs[A];if(u.name.toLowerCase()===m.name.toLowerCase()&&u.clockRate===m.clockRate&&("rtx"!==u.name.toLowerCase()||
...
break}}});return w}function g(l,t,w){return-1!=={offer:{setLocalDescription:["stable","have-local-offer"],setRemoteDescription:["stable","have-remote-offer"]},answer:{setLocalDescription:["have-remote-offer","have-local-pranswer"],setRemoteDescription:["have-local-offer","have-remote-pranswer"]}}[t][l].indexOf(w)}function r(l,t){var w=l.getRemoteCandidates().find(function(q){return t.foundation===q.foundation&&t.ip===q.ip&&t.port===q.port&&t.priority===q.priority&&t.protocol===q.protocol&&t.type===
q.type});w||l.addRemoteCandidate(t);return!w}function k(l,t){t=Error(t);t.name=l;t.code={NotSupportedError:9,InvalidStateError:11,InvalidAccessError:15,TypeError:void 0,OperationError:void 0}[l];return t}var f=a("sdp");b.exports=function(l,t){function w(m,n){n.addTrack(m);n.dispatchEvent(new l.MediaStreamTrackEvent("addtrack",{track:m}))}function q(m,n){n.removeTrack(m);n.dispatchEvent(new l.MediaStreamTrackEvent("removetrack",{track:m}))}function y(m,n,x,z){var B=new Event("track");B.track=n;B.receiver=
...
X=L.iceGatherer,J=L.iceTransport,I=L.dtlsTransport,O=L.localCapabilities,R=L.remoteCapabilities;if(!(f.isRejected(C)&&0===f.matchPrefix(C,"a=bundle-only").length||L.rejected)){var Y=f.getIceParameters(C,z);C=f.getDtlsParameters(C,z);B&&(C.role="server");n.usingBundle&&0!==G||(n._gather(L.mid,G),"new"===J.state&&J.start(X,Y,B?"controlling":"controlled"),"new"===I.state&&I.start(C));G=h(O,R);n._transceive(L,0<G.codecs.length,!1)}})}n._localDescription={type:m.type,sdp:m.sdp};"offer"===m.type?n._updateSignalingState("have-local-offer"):
...
G=0<f.matchPrefix(C,"a=ice-lite").length,L=0<f.matchPrefix(C,"a=group:BUNDLE ").length;n.usingBundle=L;var X=f.matchPrefix(C,"a=ice-options:")[0];n.canTrickleIceCandidates=X?0<=X.substr(14).split(" ").indexOf("trickle"):!1;B.forEach(function(J,I){var O=f.splitLines(J),R=f.getKind(J),Y=f.isRejected(J)&&0===f.matchPrefix(J,"a=bundle-only").length,ja=O[0].substr(2).split(" ")[2];O=f.getDirection(J,C);var U=f.parseMsid(J),ma=f.getMid(J)||f.generateIdentifier();if(Y||"application"===R&&("DTLS/SCTP"===
ja||"UDP/DTLS/SCTP"===ja))n.transceivers[I]={mid:ma,kind:R,protocol:ja,rejected:!0};else{!Y&&n.transceivers[I]&&n.transceivers[I].rejected&&(n.transceivers[I]=n._createTransceiver(R,!0));var xa=f.parseRtpParameters(J);if(!Y){var na=f.getIceParameters(J,C);var ya=f.getDtlsParameters(J,C);ya.role="client"}ja=f.parseRtpEncodingParameters(J);var za=f.parseRtcpParameters(J),Aa=0<f.matchPrefix(J,"a=end-of-candidates",C).length,ka=f.matchPrefix(J,"a=candidate:").map(function(V){return f.parseCandidate(V)}).filter(function(V){return 1===
V.component});("offer"===m.type||"answer"===m.type)&&!Y&&L&&0<I&&n.transceivers[I]&&(n._disposeIceAndDtlsTransports(I),n.transceivers[I].iceGatherer=n.transceivers[0].iceGatherer,n.transceivers[I].iceTransport=n.transceivers[0].iceTransport,n.transceivers[I].dtlsTransport=n.transceivers[0].dtlsTransport,n.transceivers[I].rtpSender&&n.transceivers[I].rtpSender.setTransport(n.transceivers[0].dtlsTransport),n.transceivers[I].rtpReceiver&&n.transceivers[I].rtpReceiver.setTransport(n.transceivers[0].dtlsTransport));
if("offer"!==m.type||Y)"answer"!==m.type||Y||(M=n.transceivers[I],ia=M.iceGatherer,R=M.iceTransport,ma=M.dtlsTransport,fa=M.rtpReceiver,Y=M.sendEncodingParameters,J=M.localCapabilities,n.transceivers[I].recvEncodingParameters=ja,n.transceivers[I].remoteCapabilities=xa,n.transceivers[I].rtcpParameters=za,ka.length&&"new"===R.state&&(!G&&!Aa||L&&0!==I?ka.forEach(function(V){r(M.iceTransport,V)}):R.setRemoteCandidates(ka)),L&&0!==I||("new"===R.state&&R.start(ia,na,"controlling"),"new"===ma.state&&ma.start(ya)),
!h(M.localCapabilities,M.remoteCapabilities).codecs.filter(function(V){return"rtx"===V.name.toLowerCase()}).length&&M.sendEncodingParameters[0].rtx&&delete M.sendEncodingParameters[0].rtx,n._transceive(M,"sendrecv"===O||"recvonly"===O,"sendrecv"===O||"sendonly"===O),!fa||"sendrecv"!==O&&"sendonly"!==O?delete M.rtpReceiver:(O=fa.track,U?(x[U.stream]||(x[U.stream]=new l.MediaStream),w(O,x[U.stream]),z.push([O,fa,x[U.stream]])):(x.default||(x.default=new l.MediaStream),w(O,x.default),z.push([O,fa,x.default]))));
else{var M=n.transceivers[I]||n._createTransceiver(R);M.mid=ma;M.iceGatherer||(M.iceGatherer=n._createIceGatherer(I,L));ka.length&&"new"===M.iceTransport.state&&(!Aa||L&&0!==I?ka.forEach(function(V){r(M.iceTransport,V)}):M.iceTransport.setRemoteCandidates(ka));J=l.RTCRtpReceiver.getCapabilities(R);15019>t&&(J.codecs=J.codecs.filter(function(V){return"rtx"!==V.name}));Y=M.sendEncodingParameters||[{ssrc:1001*(2*I+2)}];na=!1;if("sendrecv"===O||"sendonly"===O){na=!M.rtpReceiver;var fa=M.rtpReceiver||
new l.RTCRtpReceiver(M.dtlsTransport,R);if(na){O=fa.track;if(!U||"-"!==U.stream)if(U){x[U.stream]||(x[U.stream]=new l.MediaStream,Object.defineProperty(x[U.stream],"id",{get:function(){return U.stream}}));Object.defineProperty(O,"id",{get:function(){return U.track}});var ia=x[U.stream]}else x.default||(x.default=new l.MediaStream),ia=x.default;ia&&(w(O,ia),M.associatedRemoteMediaStreams.push(ia));z.push([O,fa,ia])}}else M.rtpReceiver&&M.rtpReceiver.track&&(M.associatedRemoteMediaStreams.forEach(function(V){var Ba=
V.getTracks().find(function(Qb){return Qb.id===M.rtpReceiver.track.id});Ba&&q(Ba,V)}),M.associatedRemoteMediaStreams=[]);M.localCapabilities=J;M.remoteCapabilities=xa;M.rtpReceiver=fa;M.rtcpParameters=za;M.sendEncodingParameters=Y;M.recvEncodingParameters=ja;n._transceive(n.transceivers[I],!1,na)}}});void 0===n._dtlsRole&&(n._dtlsRole="offer"===m.type?"active":"passive");n._remoteDescription={type:m.type,sdp:m.sdp};"offer"===m.type?n._updateSignalingState("have-remote-offer"):n._updateSignalingState("stable");
...
(z=!0===m.offerToReceiveVideo?1:!1===m.offerToReceiveVideo?0:m.offerToReceiveVideo)}for(n.transceivers.forEach(function(C){"audio"===C.kind?(x--,0>x&&(C.wantReceive=!1)):"video"===C.kind&&(z--,0>z&&(C.wantReceive=!1))});0<x||0<z;)0<x&&(n._createTransceiver("audio"),x--),0<z&&(n._createTransceiver("video"),z--);var B=f.writeSessionBoilerplate(n._sdpSessionId,n._sdpSessionVersion++);n.transceivers.forEach(function(C,G){var L=C.track,X=C.kind,J=C.mid||f.generateIdentifier();C.mid=J;C.iceGatherer||(C.iceGatherer=
n._createIceGatherer(G,n.usingBundle));J=l.RTCRtpSender.getCapabilities(X);15019>t&&(J.codecs=J.codecs.filter(function(I){return"rtx"!==I.name}));J.codecs.forEach(function(I){"H264"===I.name&&void 0===I.parameters["level-asymmetry-allowed"]&&(I.parameters["level-asymmetry-allowed"]="1");C.remoteCapabilities&&C.remoteCapabilities.codecs&&C.remoteCapabilities.codecs.forEach(function(O){I.name.toLowerCase()===O.name.toLowerCase()&&I.clockRate===O.clockRate&&(I.preferredPayloadType=O.payloadType)})});
J.headerExtensions.forEach(function(I){(C.remoteCapabilities&&C.remoteCapabilities.headerExtensions||[]).forEach(function(O){I.uri===O.uri&&(I.id=O.id)})});G=C.sendEncodingParameters||[{ssrc:1001*(2*G+1)}];L&&15019<=t&&"video"===X&&!G[0].rtx&&(G[0].rtx={ssrc:G[0].ssrc+1});C.wantReceive&&(C.rtpReceiver=new l.RTCRtpReceiver(C.dtlsTransport,X));C.localCapabilities=J;C.sendEncodingParameters=G});"max-compat"!==n._config.bundlePolicy&&(B+="a=group:BUNDLE "+n.transceivers.map(function(C){return C.mid}).join(" ")+
...
JSON.parse(JSON.stringify(q)),q.fec={ssrc:l,mechanism:k?"red+ulpfec":"red"},h.push(q)))});0===h.length&&l&&h.push({ssrc:l});var w=e.matchPrefix(d,"b=");w.length&&(w=0===w[0].indexOf("b=TIAS:")?parseInt(w[0].substr(7),10):0===w[0].indexOf("b=AS:")?950*parseInt(w[0].substr(5),10)-16E3:void 0,h.forEach(function(q){q.maxBitrate=w}));return h};e.parseRtcpParameters=function(d){var h={},g=e.matchPrefix(d,"a=ssrc:").map(function(r){return e.parseSsrcMedia(r)}).filter(function(r){return"cname"===r.attribute})[0];
...
document.webkitCancelFullScreen&&document.webkitCancelFullScreen())}isFullscreen(){return document.fullscreen||document.mozFullScreen||document.webkitIsFullScreen}isFunction(a){return"function"==typeof a}}var Q=new Rb;const ra={abnormal:1006,invalid_message:1008,no_free_instance:1013,out_of_control:4E3,instance_disconnected:4001,instance_not_found:4002,instance_start_failed:4003,webrtc_connection_error:4004,one_client_allowed:4005,timeout:4006,iid_required:4007,locked:4008,invalid_project:4009,kicked:4100,
syncing_data:4101,instance_killed_by_user:4102,invalid_password:4103,nodeservice_stopped:4105,instance_is_busy:4107,ip_not_authorized:4108,invalid_token:4109};class Sb{constructor(a){this.FrameDisplayDeltaTimeMs=this.BrowserReceiptTimeMs=this.UETransmissionTimeMs=this.UECaptureToSendMs=this.UEEncodeMs=this.UEReceiptTimeMs=this.TestStartTimeMs=null;this.onReady=a}reset(){this.FrameDisplayDeltaTimeMs=this.BrowserReceiptTimeMs=this.UETransmissionTimeMs=this.UEEncodeMs=this.UECaptureToSendMs=this.UEReceiptTimeMs=
...
d.browserSideLatency=d.browserSideLatency.toFixed(1));if(this.onReady)this.onReady(d)}}}class Tb{constructor(a){this.useStats=a.useStats;this.events=a.events;this.webRtcConfig=a.peerConnectionOptions||{};this.webRtcConfig.sdpSemantics="unified-plan";this.tnClient=this.dcClient=this.pcClient=null;this.sdpConstraints={offerToReceiveAudio:0,offerToReceiveVideo:1,voiceActivityDetection:!1};this.dataChannelOptions={ordered:!0};this.lastStats={};this.playerId=0;this.latencyTestTimings=new Sb(this.events.onLatencyTimingsReady);
...
return{x:32767*a,y:32767*b}}return{x:this.videoAspectRatio/this.playerAspectRatio*a/(.5*this.container.clientWidth)*32767,y:b/(.5*this.container.clientHeight)*32767}}sendTouch(a,b){this.callOnUserInteraction();var c=new DataView(new ArrayBuffer(2+10*b.length));c.setUint8(0,a);c.setUint8(1,b.length);let e=2,d=[];for(let h=0;h<b.length;h++){let g=b[h],r=g.clientX-this.video.offsetLeft,k=g.clientY-this.video.offsetTop,f=this.normalizeAndQuantizeUnsigned(r,k),l=this.ongoingTouchIndexById(g.identifier);
if(0>l){if(this.onTouch)this.onTouch("can't figure out which touch to continue")}else c.setUint16(e,f.x,!0),e+=2,c.setUint16(e,f.y,!0),e+=2,c.setInt32(e,l,!0),e+=4,c.setUint8(e,255*g.force,!0),e+=1,c.setUint8(e,f.inRange?1:0,!0),e+=1,this.onTouch&&d.push(`{${l} (${parseInt(r)},${parseInt(k)})->(${parseInt(f.x)},${parseInt(f.y)}) ${255*g.force} ${f.inRange?1:0}}`)}this.rtc.send(c.buffer);this.onTouch&&(c="",80==a?c="start":82==a?c="move":81==a&&(c="end"),a=`[${c}] N${b.length} ${d.join(",")}}`,this.onTouch(a))}sendKeydown(a){this.callOnUserInteraction();
this.rtc.send((new Uint8Array([60,va(a),a.repeat])).buffer)}sendKeyup(a){this.callOnUserInteraction();this.rtc.send((new Uint8Array([61,va(a)])).buffer)}sendKeypress(a){this.callOnUserInteraction();let b=new DataView(new ArrayBuffer(3));b.setUint8(0,62);b.setUint16(1,a.charCode,!0);this.rtc.send(b.buffer)}sendMouseEnter(){this.callOnUserInteraction();var a=new DataView(new ArrayBuffer(1));a.setUint8(0,70);this.rtc.send(a.buffer)}sendMouseLeave(){this.callOnUserInteraction();var a=new DataView(new ArrayBuffer(1));
a.setUint8(0,71);this.rtc.send(a.buffer)}sendMouseMove(a,b,c,e){this.callOnUserInteraction();this.normalizeAndQuantizeUnsigned&&(a=this.normalizeAndQuantizeUnsigned(a,b),c=this.normalizeAndQuantizeSigned(c,e),e=new DataView(new ArrayBuffer(9)),e.setUint8(0,74),e.setUint16(1,a.x,!0),e.setUint16(3,a.y,!0),e.setInt16(5,c.x,!0),e.setInt16(7,c.y,!0),this.rtc.send(e.buffer))}sendMouseDown(a,b,c){this.callOnUserInteraction();this.normalizeAndQuantizeUnsigned&&(b=this.normalizeAndQuantizeUnsigned(b,c),c=
new DataView(new ArrayBuffer(6)),c.setUint8(0,72),c.setUint8(1,a),c.setUint16(2,b.x,!0),c.setUint16(4,b.y,!0),this.rtc.send(c.buffer))}sendMouseUp(a,b,c){this.normalizeAndQuantizeUnsigned&&(b=this.normalizeAndQuantizeUnsigned(b,c),c=new DataView(new ArrayBuffer(6)),c.setUint8(0,73),c.setUint8(1,a),c.setUint16(2,b.x,!0),c.setUint16(4,b.y,!0),this.rtc.send(c.buffer))}sendMouseWheel(a,b,c){this.callOnUserInteraction();this.normalizeAndQuantizeUnsigned&&(b=this.normalizeAndQuantizeUnsigned(b,c),c=new DataView(new ArrayBuffer(7)),
c.setUint8(0,75),c.setInt16(1,a,!0),c.setUint16(3,b.x,!0),c.setUint16(5,b.y,!0),this.rtc.send(c.buffer))}}class Xb extends ha{constructor(a){super(a);this.create()}create(){this.el||(this.el=document.createElement("i"),this.el.id=`statusIndicator_${this.uid}`,this.el.className="__statusIndicator",this.appendElement(this.el))}destroy(){this.el&&(this.removeElement(this.el),this.el=null)}setStatus(a){let b="Red",c=this.get("statusIndicator");switch(a){case S.WS_Disconnected:b="Red";c&&(c.style.display=
"inline-block");break;case S.WS_Connecting:b="RGB(200,200,200)";break;case S.WS_Connected:b="Yellow";break;case S.RTC_Opened:b="RGB(0,128,255)";break;case S.OnReady:b="RGB(0,255,0)",this.hide()}this.lastStatus=a;c&&(c.style.backgroundColor=b)}hide(){let a=this.get("statusIndicator");a&&(a.style.display="none")}}class Yb extends ha{constructor(a){super(a);this.bDelayClear=!1;this.create()}create(){this.el=document.createElement("pre");this.el.id=`debugInfoPanel_${this.uid}`;this.el.className="__startupInfoPanel";
this.el.oncontextmenu=new Function("return false");this.el.onselectstart=new Function("return false");this.appendElement(this.el);this._visible=!0}destroy(){this.el&&(this.removeElement(this.el),this.el=null)}setVisible(a){!this._visible&&a&&this.el&&(this.el.innerText="");this._visible!=a&&this.el&&((this._visible=a)?(this.el.className="__startupInfoPanel",this.el.style.display="block"):this.el.style.display="none",this.setNeedReposUI())}hide(){this.el.className="__startupInfoPanel __fadeoutComp";
setTimeout(()=>this.setVisible(!1),500)}setDelayClear(a){this.bDelayClear=a}log(a){if(this.el){if(this.bDelayClear)this.bDelayClear=!1,this.el.innerText=a+"\n";else{let b=this.el.innerText;b+=a+"\n";this.el.innerText=b}this.el.scrollTop=this.el.scrollHeight+100}}setPosition(a){a||(a=this.container.getBoundingClientRect());this.el&&(this.el.style.height=`${a.height-20}px`)}}class ba{}ba.Information='<svg width="22" height="22" viewBox="0 0 32 32"><g transform="translate(1878 2755)"><rect width="32" height="32" transform="translate(-1878 -2755)" fill="none"/><path d="M11,22A11,11,0,0,1,3.222,3.222,11,11,0,1,1,18.779,18.778,10.929,10.929,0,0,1,11,22ZM8.5,10a.5.5,0,0,0-.5.5v2a.5.5,0,0,0,.5.5H10v5.5a.5.5,0,0,0,.5.5h2a.5.5,0,0,0,.5-.5v-8a.5.5,0,0,0-.5-.5ZM11,4a2,2,0,1,0,2,2A2,2,0,0,0,11,4Z" transform="translate(-1873 -2750)" fill="#3c3b3c"/></g></svg>';
ba.FullScreenEnter='<svg width="22" height="22" viewBox="0 0 32 32"><g id="cloud_icon_fullscreen_def" transform="translate(1787 2755)"><rect width="32" height="32" transform="translate(-1787 -2755)" fill="none"/><g transform="translate(0 -0.5)"><g transform="translate(-1780 -2747.5)"><rect width="10" height="10" transform="translate(-2 -2)" fill="none"/><path d="M12,0H7A1,1,0,0,0,6,1V6" transform="translate(-6)" fill="none" stroke="#3c3b3c" stroke-width="2"/><path d="M6,6.5,0,1" transform="translate(0.5 -0.5)" fill="none" stroke="#3c3b3c" stroke-width="2"/></g><g transform="translate(-1782 -2737.5)"><rect width="10" height="10" fill="none"/><path d="M12,6H7A1,1,0,0,1,6,5V0" transform="translate(-4 2)" fill="none" stroke="#3c3b3c" stroke-width="2"/><path d="M6,1,0,6.5" transform="translate(2.5 1)" fill="none" stroke="#3c3b3c" stroke-width="2"/></g><g transform="translate(-1770 -2749.5)"><rect width="10" height="10" fill="none"/><path d="M6,0h5a1,1,0,0,1,1,1V6" transform="translate(-4 2)" fill="none" stroke="#3c3b3c" stroke-width="2"/><path d="M0,6.5,6,1" transform="translate(1.5 1.5)" fill="none" stroke="#3c3b3c" stroke-width="2"/></g><g transform="translate(-1770 -2737.5)"><rect width="10" height="10" fill="none"/><path d="M6,6h5a1,1,0,0,0,1-1V0" transform="translate(-4 2)" fill="none" stroke="#3c3b3c" stroke-width="2"/><path d="M0,1,6,6.5" transform="translate(1.5 1)" fill="none" stroke="#3c3b3c" stroke-width="2"/></g></g></g></svg>';
ba.FullScreenExit='<svg width="22" height="22" viewBox="0 0 32 32"><g id="cloud_icon_exotfullsc_def" transform="translate(1744 2755)"><rect width="32" height="32" transform="translate(-1744 -2755)" fill="none"/><g transform="translate(0 -1)"><g transform="translate(-1739 -2749)"><rect width="10" height="10" fill="none"/><path d="M6,6h5a1,1,0,0,0,1-1V0" transform="translate(-4 2)" fill="none" stroke="#3c3b3c" stroke-width="2"/><path d="M0,1,6,6.5" transform="translate(1.5 1)" fill="none" stroke="#3c3b3c" stroke-width="2"/></g><g transform="translate(-1739 -2737)"><rect width="10" height="10" fill="none"/><path d="M6,0h5a1,1,0,0,1,1,1V6" transform="translate(-4 2)" fill="none" stroke="#3c3b3c" stroke-width="2"/><path d="M0,6.5,6,1" transform="translate(1.5 1.5)" fill="none" stroke="#3c3b3c" stroke-width="2"/></g><g transform="translate(-1727 -2749)"><rect width="10" height="10" fill="none"/><path d="M12,6H7A1,1,0,0,1,6,5V0" transform="translate(-4 2)" fill="none" stroke="#3c3b3c" stroke-width="2"/><path d="M6,1,0,6.5" transform="translate(2.5 1)" fill="none" stroke="#3c3b3c" stroke-width="2"/></g><g transform="translate(-1727 -2737)"><rect width="10" height="10" fill="none"/><path d="M12,0H7A1,1,0,0,0,6,1V6" transform="translate(-4 2)" fill="none" stroke="#3c3b3c" stroke-width="2"/><path d="M6,6.5,0,1" transform="translate(2.5 1.5)" fill="none" stroke="#3c3b3c" stroke-width="2"/></g></g></g></svg>';
ba.InitialCamera='<svg width="22" height="22" viewBox="0 0 32 32"><g id="cloud_icon_initialpos_def" transform="translate(1831 2755)"><rect width="32" height="32" transform="translate(-1831 -2755)" fill="none"/><path d="M18.667,22.222H1.333A1.333,1.333,0,0,1,0,20.893V8.24A1.319,1.319,0,0,1,.5,7.2L9.167.292a1.335,1.335,0,0,1,1.666,0L19.5,7.2A1.319,1.319,0,0,1,20,8.24V20.893A1.333,1.333,0,0,1,18.667,22.222ZM9,12.11a1,1,0,0,0-1,1v6a1,1,0,0,0,1,1h2a1,1,0,0,0,1-1v-6a1,1,0,0,0-1-1Z" transform="translate(-1825 -2751.11)" fill="#3c3b3c" stroke="rgba(0,0,0,0)" stroke-width="1"/></g></svg>';
class Zb extends ha{constructor(a,b,c){super(a);this.updateConnectionCount(b);this.createButton(c)}createButton(a){this.elButton||(this.elButton=document.createElement("button"),this.elButton.id=`liveStatusSwitchButton_${this.uid}`,this.elButton.innerHTML=ba.Information,this.elButton.title=a,this.elButton.className="__liveStatusSwitchButton",this.elButton.oncontextmenu=new Function("return false"),this.elButton.onselectstart=new Function("return false"),this.elButton.onclick=()=>this.setPanelVisible(),
...
32}px`);if(this.elPanel)if(this.customPosX&&this.customPosY)this.elPanel.style.left=this.customPosX+"px",this.elPanel.style.top=this.customPosY+"px";else{let b=this.elPanel.getBoundingClientRect();this.elPanel.style.left="5px";this.elPanel.style.top=`${a.height-b.height-42}px`}}destroy(){this.updateLatencyTestUI=!1;this.visible&&this.setPanelVisible();this.elPanel&&(this.removeElement(this.elPanel),this.elPanel=null);this.elButton&&(this.removeElement(this.elButton),this.elButton=null)}setPanelVisible(a,
b){this.customPosX=a;this.customPosY=b;if(this.elPanel)if("none"==this.elPanel.style.display)this.updateConnectionCount(),this.elPanel.style.display="block",this.elPanel.className="__liveStatusPanel __fadeinComp",this.visible=!0,this.player.rtc.sendEnableIntervalSendQP(!0);else{this.elPanel.className="__liveStatusPanel __fadeoutComp";setTimeout(()=>{this.visible=!1;this.elPanel.style.display="none";this.player.rtc.sendEnableIntervalSendQP(!1);this.setNeedReposUI();this.resize()},500);return}else this.createPanel(),
this.visible=!0,this.resize(),this.updateConnectionCount(),this.player.rtc.requestInitialSettings(),this.player.rtc.sendEnableIntervalSendQP(!0);this.setNeedReposUI();this.resize()}adjustMaxQP(a){return 18==a?(this.get("i_settings_maxQP")&&this.get("i_settings_maxQP").add(new Option(18,18)),18):0>a?40:0<=a&&29>a?29:40<a?40:a}adjustMaxBitrate(a){return 300==a?(this.get("i_settings_maxBitrate")&&this.get("i_settings_maxBitrate").add(new Option(300,300)),300):10>a?10:100<a?100:a}formatNumber(a,b){return"undefined"==
typeof a?"-":(new Intl.NumberFormat(window.navigator.language,{maximumFractionDigits:b||0})).format(a)}processValue(a){return a}updateButtonTip(a){this.elButton&&(this.elButton.title=a)}updateConnectionCount(a){void 0!=a&&(this.playersCount=a);this.setText("i_connections",this.playersCount);this.updatePlayerId()}updatePlayerId(){this.setText("i_playerId",this.player.playerId+(this.player.isQualityController()?"-QC":""))}updateWebRtcStats(a){if(this.visible){var b=(a.timestamp-a.timestampStart)/1E3,
c=new Intl.NumberFormat(window.navigator.language,{maximumFractionDigits:0,minimumIntegerDigits:2}),e=[],d=[60,60];for(let h=0;h<d.length;h++)e.push(b%d[h]),b/=d[h];e.push(b);b=c.format(e[0]);d=c.format(Math.floor(e[1]));c=c.format(Math.floor([e[2]]));this.setText("i_duration",c+":"+d+":"+b);this.setText("i_resolution",a.frameWidth&&a.frameHeight?a.frameWidth+" x "+a.frameHeight:"-");c="B";e=a.bytesReceived||0;b=["kB","MB","GB"];for(d=0;d<b.length&&!(1E5>e);d++)e/=1E3,c=b[d];this.setText("i_bytesReceived",
this.formatNumber(e)+" "+c);this.setText("i_framesReceived",this.processValue(a.framesReceived));this.setText("i_framesDecoded",a.framesDecoded);this.setText("i_keyframesDecoded",this.processValue(a.keyFramesDecoded));this.updateVideoFramerate(this.formatNumber(a.framesPerSecond));this.updateBitrate(a.bitrate);this.setText("i_packetsLost",this.processValue(a.packetsLost));this.setText("i_frameDropped",this.processValue(a.framesDropped));this.setText("i_compositeTime",this.formatNumber(a.receiveToCompositeMs,
1))}}updateVideoFramerate(a){let b=this.get("i_framerateVideo");b.style.color=10>a?"red":20>a?"orange":"rgb(128,255,0)";b.innerText=a}updateBitrate(a){let b=this.get("i_bitrate");a?1E3<a?(b.style.color="rgb(128,255,0)",b.innerText=this.formatNumber(a/1E3,1)+" Mbps"):(b.style.color=100>a?"red":1E3>a?"orange":"rgb(128,255,0)",b.innerText=this.formatNumber(a)+" kbps"):b.innerText="-"}updateInitialSettings(a){let b=this.adjustMaxQP(a.Encoder.MaxQP);this.setValue("i_settings_maxQP",b);a=this.adjustMaxBitrate(a.WebRTC.MaxBitrate/
1E3/1E3);this.setValue("i_settings_maxBitrate",a)}updateQPAndRenderFPS(a,b){let c=this.get("i_qp");c.style.color=35<a?"red":26<a?"orange":"rgb(128,255,0)";c.innerText=a;this.get("i_framerateRender").innerText=this.processValue(b)}}class $b extends ha{constructor(a){super(a);this.create()}create(){this.el||(this.el=document.createElement("button"),this.el.id=`fullscreeButton_${this.uid}`,this.el.className="__fullscreeButton",this.el.innerHTML=ba.FullScreenEnter,this.el.title="\u8fdb\u5165\u5168\u5c4f",
this.el.oncontextmenu=new Function("return false"),this.el.onselectstart=new Function("return false"),this.el.onclick=()=>this.player.fullscreen=!this.player.fullscreen,this.el.onmousedown=a=>{1==a.button&&a.preventDefault()},this.appendElement(this.el),document.addEventListener("fullscreenchange",()=>{this.el.title="\u9000\u51fa\u5168\u5c4f";this.el.innerHTML=Q.isFullscreen()?ba.FullScreenExit:ba.FullScreenEnter;this.player.resize()}))}destroy(){this.el&&(this.removeElement(this.el),this.el=null)}setPosition(a,
b){a||(a=this.container.getBoundingClientRect());this.el&&(this.el.style.left=`${b?38:5}px`,this.el.style.top=`${a.height-32}px`)}}class ac extends ha{constructor(a){super(a);this.create()}create(){if(!this.el){var a=[];a.push("\u9f20\u6807\u5de6\u952e\u70b9\u51fb\uff1a\u56de\u5230\u4fdd\u5b58\u7684\u4f4d\u7f6e\u6216\u8005\u5de5\u7a0b\u521d\u59cb\u4f4d\u7f6e");a.push("\u9f20\u6807\u53f3\u952e\u70b9\u51fb\uff1a\u4fdd\u5b58\u5f53\u524d\u7684\u76f8\u673a\u4f4d\u7f6e");a.push("\u9f20\u6807\u4e2d\u95f4\u70b9\u51fb\uff1a\u5c06\u5f53\u524d\u4f4d\u7f6e\u8bbe\u7f6e\u4e3a\u5de5\u7a0b\u521d\u59cb\u4f4d\u7f6e\u5e76\u8df3\u8f6c");
a=a.join("\n");this.el=document.createElement("button");this.el.id=`viewHomeButton_${this.uid}`;this.el.className="__viewHomeButton";this.el.innerHTML=ba.InitialCamera;this.el.title=a;this.el.oncontextmenu=new Function("return false");this.el.onselectstart=new Function("return false");this.el.onclick=b=>this.player.viewHome(0);this.el.onmousedown=b=>{0!=b.button&&this.player.viewHome(b.button);b.preventDefault()};this.appendElement(this.el)}}destroy(){this.el&&(this.removeElement(this.el),this.el=
null)}setPosition(a,b,c){a||(a=this.container.getBoundingClientRect());if(this.el){let e=5;if(b&&c)e=70;else if(b||c)e=38;this.el.style.left=e+"px";this.el.style.top=`${a.height-32}px`}}}class bc extends ha{constructor(a){super(a);this.elContainer=document.createElement("div");this.elContainer.id=`taskWaiting_${this.uid}`;this.elContainer.className="__taskWaiting";this.elContainer.oncontextmenu=new Function("return false");this.elContainer.onselectstart=new Function("return false");this.appendElement(this.elContainer);
this.elText=document.createElement("div");this.elText.style.marginBottom="15px";this.elText.innerText="dddd";this.elContainer.appendChild(this.elText);this.elButton=document.createElement("input");this.elButton.type="button";this.elButton.value="\u7acb\u5373\u91cd\u542f\u5b9e\u4f8b";this.elButton.onclick=()=>{this.player.setInstanceOptions({iid:this.player.options.iid,reset:!0})};this.elContainer.appendChild(this.elButton);this.setMode(0)}setMode(a){this._mode=a;0===a?this.elContainer.style.background=
"transparent":(this.elContainer.style.background="rgba(64,64,64,0.5)",this.elContainer.style.height="26px",this.elContainer.style.lineHeight="26px")}destroy(){this.elContainer&&(this.removeElement(this.elContainer),this.elContainer=null)}updateText(a){this.elText&&(this.elText.innerText=a,this.show())}show(){this.elContainer.className="__taskWaiting";this.elContainer.style.display="block"}hide(){this.elContainer.className="__taskWaiting __fadeoutComp";setTimeout(()=>this.elContainer.style.display=
"none",500)}setPosition(a,b,c,e){if(this.elContainer)if(a||(a=this.container.getBoundingClientRect()),0==this._mode){var d=a.width/2-150;0>d&&(d=10);this.elContainer.style.left=d+"px";this.elContainer.style.top=a.height/2+"px"}else d=0,b&&d++,c&&d++,e&&d++,a=a.height-32,this.elContainer.style.left=(0==d?5:1==d?38:2==d?70:102)+"px",this.elContainer.style.top=a+"px"}}class cc extends ha{constructor(a){super(a);this.el=document.createElement("pre");this.el.id=`touchEventsPanel_${this.uid}`;this.el.className=
"__touchEventsPanel";this.el.oncontextmenu=new Function("return false");this.el.onselectstart=new Function("return false");this.appendElement(this.el)}destroy(){this.el&&(this.removeElement(this.el),this.el=null)}appendText(a){if(this.el){let b=this.el.innerText;b+=a+"\n";this.el.innerText=b;this.el.scrollTop=this.el.scrollHeight+100}}setPosition(a){a||(a=this.container.getBoundingClientRect());this.el&&(this.el.style.width=`${a.width}px`)}}var ta=0;class dc{constructor(a,b){if(a){this.host=a;this.options=
b;la.processParams(this.options);this.uid=++ta;this.options.apiOptions.player=this;this.api=new qa(null,this.options.apiOptions);if(this.options.domId)if(a=ua(this.options.domId))this.container=document.createElement("div"),this.container.style="position:relative;width:100%;height:100%;",a.innerHTML="",a.appendChild(this.container);else if("loading"==document.readyState){console.error("DOM\u5c1a\u5728\u52a0\u8f7d\u4e2d\uff0c\u6b64\u65f6\u4e0d\u80fd\u521d\u59cb\u5316AirCityPlayer!");return}if(this.hasVideo=
!!this.container)this.styleManager=new Vb,this.createWidgetsInConstructor(),this.canAdaptiveResolution=!1,this.lastResizeTime=(new Date).getTime(),this.orientationChangeTimeout=void 0;this.constructUrlAndConnect();this.resetInteractTimestamp()}else console.error("[AirCityPlayer] The parameter `host` cannot be empty!")}constructUrlAndConnect(){this.logStartupInfo(`host: ${this.host}`);this.useHttps="https:"==location.protocol||this.options.useHttps;this.url=`${this.useHttps?"wss":"ws"}://${this.host}/player?hasVideo=${this.hasVideo}`;
this.options.offer&&(this.url+="&offer=1");this.options.iid&&(this.url+="&iid="+this.options.iid);this.options.pid&&(this.url+="&pid="+this.options.pid);this.options.password&&(this.url+="&password="+this.options.password);if("object"==typeof this.options.urlExtraInfo)for(let a in this.options.urlExtraInfo)this.url+="&"+a+"="+this.options.urlExtraInfo[a];this.options.reset&&(this.url+="&reset=1",this.options.reset=!1);setTimeout(()=>this.connectSignallingServer(),200)}callEvent(a,b,c){a=this.options.events[a];
"function"==typeof a&&a(b,c)}getHost(){return this.host}getAPI(){return this.api}getInstanceInfo(){return this.paramInfo}getVideoSize(){if(this.htmlVideo.valid())return{width:this.htmlVideo.videoWidth(),height:this.htmlVideo.videoHeight()}}setResolution(a,b){window.devicePixelRatio&&(a*=window.devicePixelRatio,b*=window.devicePixelRatio);if(3840<a||2160<b)b=a/b,b>=3840/2160?(a=3840,b=3840/b):(a=2160*b,b=2160);this.streamerAdaptive&&this.streamerLimitMaxResolution&&(a>this.streamerResX||b>this.streamerResY)&&
(b=a/b,b>=this.streamerResX/this.streamerResY?(a=this.streamerResX,b=this.streamerResX/b):(a=this.streamerResY*b,b=this.streamerResY));a=Math.floor(a);b=Math.floor(b);let c=this.htmlVideo.videoWidth(),e=this.htmlVideo.videoHeight();(a!=c&&a+1!=c&&a-1!=c||b!=e&&b+1!=e&&b-1!=e)&&this.rtc&&this.rtc.updateRenderResolution(a,b)}destroy(a){console.log(`call AirCityPlayer.destroy: ${a||" "}`);this.isDestroyed||(ta--,this.isDestroyed=!0,this.destroyReason=a,this.rtc&&this.rtc.close(),this.signallingConnection&&
this.signallingConnection.close())}setKeyEventTarget(a){this.htmlVideo&&this.htmlVideo.setKeyEventTarget(a)}setKeyEventReceiver(a){this.setKeyEventTarget(a)}resize(){if(this.container){this.rect=this.container.getBoundingClientRect();if(this.bNeedReposUI||!this.oldRect||this.oldRect.width!=this.rect.width||this.oldRect.height!=this.rect.height)this.bNeedReposUI=!1,this.oldRect=this.rect,this.startupInfo&&this.startupInfo.setPosition(this.rect),this.liveStatus&&this.liveStatus.setPosition(this.rect),
this.fullscreenButton&&this.fullscreenButton.setPosition(this.rect,this.options.ui.statusButton),this.homeButton&&this.homeButton.setPosition(this.rect,this.options.ui.statusButton,this.options.ui.fullscreenButton),this.taskListBar&&this.taskListBar.setPosition(this.rect,this.options.ui.statusButton,this.options.ui.fullscreenButton,this.options.ui.homeButton);this.htmlVideo.valid()&&(this.canAdaptiveResolution&&(this._updateVideoStreamSize||(this._updateVideoStreamSize=()=>{1E3<(new Date).getTime()-
this.lastResizeTime?(this.setResolution(this.htmlVideo.clientWidth(),this.htmlVideo.clientHeight()),this.lastResizeTime=(new Date).getTime()):(clearTimeout(this.resizeTimerId),this.resizeTimerId=setTimeout(a=>this._updateVideoStreamSize(),1E3))}),this._updateVideoStreamSize()),this.htmlVideo&&this.htmlVideo.resize(this.streamerAdaptive&&this.canAdaptiveResolution))}}setInstanceOptions(a){const b=this;return $jscomp.asyncExecutePromiseGeneratorFunction(function*(){var c=a.pid==b.options.pid&&a.iid==
b.options.iid||!a.pid&&a.iid==b.options.iid||!a.iid&&a.pid==b.options.pid;if(c&&!a.reset)b.api.log("setInstanceOptions: no change.");else{if(!c){c=(!a.iid||a.iid==b.options.iid)&&a.pid!=b.options.pid;if(b.streamerLocked&&c){b.api.log("\u5f53\u524d\u5b9e\u4f8b\u5df2\u8bbe\u7f6e\u9501\u5b9a\u5de5\u7a0b\uff0c\u65e0\u6cd5\u901a\u8fc7API\u63a5\u53e3\u5207\u6362\u5de5\u7a0b");return}c=yield b.signallingConnection.checkParams(a);if(null!==c){if(!1===c.iid){b.api.log(`iid(${a.iid})\u5bf9\u5e94\u7684\u5b9e\u4f8b\u4e0d\u5b58\u5728\uff0c\u8bf7\u786e\u8ba4`);
return}if(!1===c.pid){b.api.log(`pid(${a.pid})\u5bf9\u5e94\u7684\u5de5\u7a0b\u4e0d\u5b58\u5728\uff0c\u8bf7\u786e\u8ba4`);return}}}b.destroy();b.options.iid=a.iid;b.options.pid=a.pid;b.options.reset=a.reset;b.constructUrlAndConnect()}})}set fullscreen(a){a?Q.fullscreen(this.container):Q.exitFullscreen()}get fullscreen(){return!!document.fullscreenElement}setActionEventEnabled(a){this.htmlVideo&&this.htmlVideo.setActionEventEnabled(a)}onApiReady(){this.setStatus(S.OnReady);this.signallingConnection&&
this.signallingConnection.sendReady();1==this.options.ui.mainUI?this.api.settings.setMainUIVisibility(!0):0==this.options.ui.mainUI&&this.api.settings.setMainUIVisibility(!1);1==this.options.ui.campass?this.api.settings.setCampassVisible(!0):0==this.options.ui.campass&&this.api.settings.setCampassVisible(!1)}onMainThreadBusy(a){if(1===a.busy){let b="BUSY! ",c=this.api.apiQueue.queueSize(),e=this.api.apiQueue.dataSize();0<c&&(b+=`JS\u961f\u5217\uff1a${c}/${e}\uff0c`);1<a.taskCount&&(b+=`\u540e\u53f0\u961f\u5217\uff1a${a.taskCount}\uff0c`);
b+=`\u6b63\u5728\u6267\u884c\uff1a${p[a.currentTask]}\uff0c\u8bf7\u7a0d\u5019...`;this.hasVideo&&(this.htmlVideo.isVideoLoaded()&&this.options.ui.taskListBar||!this.htmlVideo.isVideoLoaded())&&this.taskListBar.updateText(b)}else this.taskListBar.hide()}viewHome(a){this.api.viewHome(a)}resetInteractTimestamp(){this.timestampForInteraction=(new Date).getTime()}receiveParamInfo(a){this.paramInfo=a;let b=a.project,c=a.nodeIP,e=a.hostName;this.options.iid=a.iid;this.options.pid=a.pid;this.streamerAdaptive=
a.adjustResolution;this.streamerLimitMaxResolution=a.limitMaxResolution;this.streamerResX=a.resX;this.streamerResY=a.resY;this.streamerLocked=a.locked;if(this.kickOutInMinutes=a.kickOutInMinutes){let d=setInterval(()=>{(new Date).getTime()-this.timestampForInteraction>6E4*this.kickOutInMinutes&&(this.destroy("\u957f\u65f6\u95f4\u672a\u4f7f\u7528\u8fde\u63a5\u5df2\u65ad\u5f00"),console.warn("\u957f\u65f6\u95f4\u672a\u4f7f\u7528\u8fde\u63a5\u5df2\u65ad\u5f00"),clearInterval(d))},2E4)}this.nodeInfoArray=
["\u6e32\u67d3\u8282\u70b9\u4fe1\u606f\uff1a"];e&&this.nodeInfoArray.push("\t\u4e3b\u673a\u540d\u79f0\uff1a"+e);c&&this.nodeInfoArray.push("\t\u4e3b\u673a\u5730\u5740\uff1a"+c);b&&this.nodeInfoArray.push("\t\u3000\u5de5\u7a0b\uff1a"+b);this.options.pid&&this.nodeInfoArray.push("\t\u5de5\u7a0bID\uff1a"+this.options.pid);this.nodeInfoArray.push("\t\u5b9e\u4f8bID\uff1a"+this.options.iid);this.nodeInfoArray.push("\t\u81ea\u9002\u5e94\uff1a"+this.streamerAdaptive);this.nodeInfoArray.push("\t\u9650\u5236\u6700\u5927\u5206\u8fa8\u7387\uff1a"+
this.streamerLimitMaxResolution);this.nodeInfoArray.push(`\t\u5206\u8fa8\u7387\uff1a${this.streamerResX}x${this.streamerResY}`);this.liveStatus&&this.liveStatus.updateButtonTip(this.nodeInfoArray.join("\n"));this.api.log(this.nodeInfoArray.join("\n\t"))}logStartupInfo(a){if(a){var b=new Date;a=`[${oa(b.getHours(),2)+":"+oa(b.getMinutes(),2)+":"+oa(b.getSeconds(),2)+"."+oa(b.getMilliseconds(),3)}] ${a}`;this.startupInfo&&this.startupInfo.log(a);1<ta&&(a=`[${this.uid}] `+a);console.log("[DEBUG]"+a);
this.api.log(a)}}setStatus(a,b){this.cloudStatus=a;this.statusIndicator&&this.statusIndicator.setStatus(a);switch(a){case S.WS_Disconnected:if(this.isDestroyed){console.log("destroyed.");break}b&&(this.logStartupInfo(b),console.warn(b));break;case S.WS_Connecting:this.logStartupInfo(`connecting ${this.useHttps?"wss":"ws"}...`);break;case S.WS_Connected:this.logStartupInfo("connected");break;case S.OnReady:this.startupInfo&&this.startupInfo.hide(),this.options.ui.debugTouchPanel&&!this.touchEventsPanel&&
setTimeout(()=>{this.touchEventsPanel=new cc(this);this.touchEventsPanel.appendText("Start recording touch events here:")},500),this.resize()}}createWidgetsInConstructor(){this.taskListBar=new bc(this);this.htmlVideo=new Wb(this,{keyEventTarget:this.options.keyEventTarget,useBuiltinCursors:this.options.useBuiltinCursors,mouseKeyListener:this.options.events.mouseKeyListener,onTouch:a=>this.debugTouchPanel&&this.touchEventsPanel.appendText(a),onVideoLoaded:()=>{this.logStartupInfo("video: loadedmetadata");
this.createWidgets();this.callEvent("onVideoLoaded");this.resize()},onMButtonDoubleClick:(a,b)=>{this.liveStatus&&this.liveStatus.setPanelVisible(a,b)}});this.options.ui.statusIndicator&&(this.statusIndicator=new Xb(this));this.options.ui.startupInfo&&(this.startupInfo=new Yb(this),this.logStartupInfo("sdk version: "+this.api.getVersion()),this.logStartupInfo("uid: "+this.uid));this.resizeObserver=new ResizeObserver(a=>this.resize());this.resizeObserver.observe(this.container)}createWidgets(){this.options.ui.statusButton&&
(this.liveStatus=new Zb(this,this.playerCount,this.nodeInfoArray.join("\n")));this.options.ui.fullscreenButton&&(this.fullscreenButton=new $b(this));this.options.ui.homeButton&&(this.homeButton=new ac(this));this.taskListBar&&this.taskListBar.setMode(1)}destroyWidgets(){this.liveStatus&&(this.liveStatus.destroy(),this.liveStatus=null);this.fullscreenButton&&(this.fullscreenButton.destroy(),this.fullscreenButton=null);this.homeButton&&(this.homeButton.destroy(),this.homeButton=null);this.touchEventsPanel&&
(this.touchEventsPanel.destroy(),this.touchEventsPanel=null);this.taskListBar&&(this.taskListBar.destroy(),this.taskListBar=null)}isQualityController(){return this.bQualityController}initWebRtcPlayer(a){this.rtc=new Tb({useStats:this.hasVideo&&(this.options.ui.statusButton||this.options.events.onRtcStatsReport),peerConnectionOptions:a.peerConnectionOptions,events:{onlog:b=>this.logStartupInfo(b),ontrack:b=>{this.htmlVideo&&this.htmlVideo.setTrack(b)},onicecandidate:b=>{this.signallingConnection&&
...
b&&this.logStartupInfo(b);a.state===ca.StartFailed?(console.error(a.info),this.options.ui.startupInfo&&setTimeout(()=>alert(a.info),500)):a.state==ca.ConfirmBusy&&(this.busyIId=a.info)}handleSignallingMessage_PlayerCount(a){this.playerCount=a.count;this.liveStatus&&this.liveStatus.updateConnectionCount(this.playerCount);(this.canAdaptiveResolution=1===a.count)&&this.resize()}}v.APIErrorCode={OK:0,InvalidParameters:1,InternalError:2,ResourceNotFound:3,AcpProjWKTNotSet:4,CoordinateConversionFailed:5,
IDExists:6,InvalidRequestType:7,InvalidRequestString:8,NoCommand:9,DataTypeNotSupport:10,InvalidOperation:11,ProjectNotOpened:12,CodeMax:65535};v.AirCityAPI=qa;v.AirCityPlayer=dc;v.AnimatedImageButtonData=La;v.BPFuncParamType={Bool:0,UInt8:1,Int32:2,Float:3,Double:4,String:5,Color:6,Vector2D:7,Vector:8,Rotator:9,IntArray:10,StringArray:11,VectorArray:12,Coordinate:13,CoordinateArray:14,FloatArray:15};v.BPFunctionData=Za;v.BeamData=Ma;v.CameraTourData=ab;v.CameraTourKeyFrame=$a;v.CloudStatus=S;v.Color=
...
LightGrey:"RGB(211,211,211)",Silver:"RGB(192,192,192)",DarkGray:"RGB(169,169,169)",Gray:"RGB(128,128,128)",DimGray:"RGB(105,105,105)",Black:"RGB(0,0,0)"};v.CommandType=p;v.CustomObjectData=Va;v.CustomObjectData2=Wa;v.CustomTagData=Ia;v.DecalData=Ta;v.DynamicWaterData=Ya;v.HeatMapPointData=Fa;v.HighlightAreaData=Ja;v.ImageButtonData=Ka;v.LayerVisibleData=Ea;v.MapMode={Campass:0,SmallMap:1,BigMap:2};v.MeasurementMode={Coordinate:1,Linear:2,Horizontal:3,Vertical:4,MultiPoint:5,TerrainArea:6};v.MousePickMask=
pa;v.ODLineData=Qa;v.PanelType={ViewshedAnalysis:0,SkylineAnalysis:1,ViewDomeAnalysis:2,VisiblityAnalysis:3,FloodFillAnalysis:4,SolarAnalysis:5,CutFillAnalysis:6,TerrainSlopeAnalysi:7,ContourLineAnalysis:8};v.PanoramaData=Sa;v.Polygon3DData=Oa;v.Polygon3DStyle={Wave:0,LoopLine:1,Gradual:2,DynamicGradual:3,WaveTransparent:4,WideWave:5,RotateArrow:6,RotateLine:7,RotateGradual:8,SingleColor:9,SingleColorWithLight:10};v.PolygonData=Ra;v.PolygonStyle={SingleColor:0,CirclePoint:1,Volumn:2,Gradual:3,DynamicGradual:4,
WaveTransparent:5,WideWave:6,RotateArrow:7,RotateLine:8,RotateGradual:9,OnTerrain:10};v.PolylineData=Pa;v.PolylineStyle={Arrow:0,Arrow1:1,Flow:2,Beam:3,Normal:4,OnTerrain:5,DottedNormal:6,DottedCircle:7};v.RadiationPointData=Na;v.TagData=Ga;v.TileLayerActorData=ea;v.TileLayerData=Ua;v.VERSION="5.3";v.VehicleViewMode={FirstPerson:0,ThirdPerson:1};v.VideoProjectionData=Xa;v.Viewport=aa;v.WaterFlowFieldStyle={HeatMap:0,Water:1};v.WebUIData=Ha;v.__onCefResponse=function(a){if(sa)sa.onConnectionMessage(a)};
Object.defineProperty(v,"__esModule",{value:!0});return v}({});(()=>{if("undefined"!=typeof module&&module.exports)module.exports=acapi;else if("function"==typeof define&&define.amd)define(function(){return acapi});else{window.AcApiVersion=acapi.VERSION;for(let v in acapi)"VERSION"!=v&&(window[v]=acapi[v]);acapi.AirCityAPI.__onApiConstructed=v=>window.__g=v}})();
