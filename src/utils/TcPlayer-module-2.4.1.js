  ...
  return (function (e) {
    ...
    function (e, t, i) {
      ...
      function a(e, t) {
        if (
          (d.IS_MOBILE
            ? ((e.flash = !1),
              d.IS_X5TBS && e.x5_player
                ? (b.mobile = ['webrtc', 'flv', 'm3u8', 'mp4'])
                : d.IS_ENABLED_MSE && e.h5_flv && (b.mobile = ['webrtc', 'flv', 'm3u8', 'mp4']))
            : ((e.flash = !!t.isFormat('rtmp') || e.flash),
              t.isFormat('flv') && void 0 == e.flash && (e.flash = !0),
              e.flash
                ? d.IS_ENABLED_FLASH ||
                  ((e.flash = !1),
                  d.IS_ENABLED_MSE
                    ? e.h5_flv && ((d.IS_SAFARI && v.compareVersion(d.SAFARI_VERSION, '10.1') > -1) || !d.IS_SAFARI)
                      ? (b.pc = ['webrtc', 'flv', 'm3u8', 'mp4'])
                      : (b.pc = ['webrtc', 'm3u8', 'mp4'])
                    : (b.pc = ['webrtc', 'mp4']))
                : d.IS_ENABLED_MSE
                ? e.h5_flv && ((d.IS_SAFARI && v.compareVersion(d.SAFARI_VERSION, '10.1') > -1) || !d.IS_SAFARI)
                  ? (b.pc = ['webrtc', 'flv', 'm3u8', 'mp4'])
      ...
      function l(e) {
        var t = {
          urls: {
            ...
            webrtc: { od: e.webrtc || '', hd: e.webrtc_hd || '', sd: e.webrtc_sd || '' },
          },
      ...
      function u(e, t) {
        for (
          var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : M, o = '', n = 0;
          n < i.length;
          n++
        )
          if (((o = i[n]), e[t][o])) return { definition: o, url: e[t][o] }
      }
      function p(e) {
        for (
      ...
      var h = i(1),
        ...
        g = i(5),
        w = m.MSG,
        b = { mobile: ['webrtc', 'm3u8', 'mp4'], pc: ['webrtc', 'rtmp', 'flv', 'm3u8', 'mp4'] },
        M = ['od', 'hd', 'sd']
    ...
    function (e, t) {
      ...
      var i = window.navigator.userAgent,
        ...
        u = ((t.IS_MAC = /Mac/i.test(i)), (t.IS_ANDROID = /Android/i.test(i))),
        p = (t.ANDROID_VERSION = (function () {
          var e,
            t,
            o = i.match(/Android (\d+)(?:\.(\d+))?(?:\.(\d+))*/i)
          return o
            ? ((e = o[1] && parseFloat(o[1])),
              (t = o[2] && parseFloat(o[2])),
              e && t ? parseFloat(o[1] + '.' + o[2]) : e ? e : null)
            : null
        })()),
        h =
          ((t.IS_OLD_ANDROID = u && /webkit/i.test(i) && p < 2.3),
        ...
        A = (t.IS_CHROME = !f && /Chrome/i.test(i)),
        m = (t.IS_SAFARI = !f && !A && /Safari/i.test(i)),
        g =
          ((t.SAFARI_VERSION = (function () {
            if (!m) return null
            var e = /version\/([\d.]+)/i,
              t = i.match(e)
            return t ? t[1] : void 0
            ...
            if (document.all || g)
              try {
                if ((e = new ActiveXObject('ShockwaveFlash.ShockwaveFlash')))
                  return (
                    (t.FLASH_VERSION = M = e.GetVariable('$version').split(' ')[1].replace(/,/g, '.')),
              ...
              try {
                if (navigator.plugins && navigator.plugins.length > 0 && (e = navigator.plugins['Shockwave Flash'])) {
                  for (var i = e.description.split(' '), o = 0; o < i.length; ++o)
                    isNaN(parseInt(i[o])) ||
                      ((t.FLASH_VERSION = M = i[o]), window.console && console.log('FLASH_VERSION', parseInt(i[o])))
                  return !0
                }
              } catch (e) {
                return !1
          ...
          (t.isBrowserSupportWebRTC = function () {
            ...
            return (
              ...
              !(
                ...
                m &&
                l &&
                (0 === c.length || c[0] < 11 || (11 === c[0] && c[1] < 1) || (11 === c[0] && 1 === c[1] && c[2] < 2))
              )
            )
          }))
      t.IS_ENABLED_WEBRTC = (function () {
        var e = function () {
          ...
          t = new Promise(function (t, i) {
            try {
              var o = { iceServers: [], sdpSemantics: 'unified-plan' },
                n = new RTCPeerConnection(o),
                r = {}
              n.addTransceiver
                ? (n.addTransceiver('audio', { direction: 'recvonly' }),
                  n.addTransceiver('video', { direction: 'recvonly' }))
                : (r = { offerToReceiveVideo: !0, offerToReceiveAudio: !0 }),
    ...
    function (e, t) {
      ...
      function i(e, t, i) {
        return e
          ? (e.addEventListener ? e.addEventListener(t, i, !1) : e.attachEvent && e.attachEvent('on' + t, i), i)
          : console.warn('element not exists')
      }
      function o(e, t, i) {
        return e
      ...
      function h(e, t, i) {
        var o = {},
          ...
          u = t.pageX || t.clientX
        return (
          t.changedTouches && ((u = t.changedTouches[0].pageX), (c = t.changedTouches[0].pageY)),
    ...
    function (e, t, i) {
      ...
      function l(e) {
        ;(h.__isFullscreen = !!document[_.fullscreenElement]),
          h.__isFullscreen ||
            (I.IS_X5TBS && w.off(h.player.video.el, 'x5videoexitfullscreen', c),
            w.off(document, _.fullscreenchange, l)),
          M.pub(
            { type: b.MSG.FullScreen, src: 'util', ts: e.timeStamp, detail: { isFullscreen: h.__isFullscreen } },
            h.player
          )
      }
      function c(e) {
        'x5videoexitfullscreen' === e.type &&
          ((h.__isFullscreen = !1),
          w.off(document, _.fullscreenchange, l),
          w.off(h.player.video.el, 'x5videoexitfullscreen', c),
          M.pub({ type: b.MSG.FullScreen, src: 'util', ts: e.timeStamp, detail: { isFullscreen: !1 } }, h.player))
      }
      function u(e) {
        'webkitbeginfullscreen' == e.type
          ? (w.off(h.player.video.el, 'webkitbeginfullscreen', u),
            w.on(h.player.video.el, 'webkitendfullscreen', u),
            M.pub({ type: b.MSG.FullScreen, src: 'util', ts: e.timeStamp, detail: { isFullscreen: !0 } }, h.player))
          : 'webkitendfullscreen' == e.type &&
            (w.off(h.player.video.el, 'webkitendfullscreen', u),
            M.pub({ type: b.MSG.FullScreen, src: 'util', ts: e.timeStamp, detail: { isFullscreen: !1 } }, h.player))
      }
      function p(e) {
      ...
      function h(e, t, i) {
        ...
        ;(h.player = e),
          _.requestFullscreen
            ? t
              ? (I.IS_X5TBS && w.on(e.video.el, 'x5videoexitfullscreen', c),
                w.on(document, _.fullscreenchange, l),
                i && i[_.requestFullscreen]())
              : document[_.exitFullscreen]()
            : o && e.video.el.webkitEnterFullScreen
            ? (w.on(e.video.el, 'webkitbeginfullscreen', u),
              t ? e.video.el.webkitEnterFullScreen() : e.video.el.webkitExitFullscreen())
            : ((h.__isFullscreen = t),
              h.__isFullscreen
                ? ((h.__origOverflow = document.documentElement.style.overflow),
                  (document.documentElement.style.overflow = 'hidden'),
                  w.on(document, 'keydown', p))
                : ((document.documentElement.style.overflow = h.__origOverflow), w.off(document, 'keydown', p)),
              w.toggleClass(document.body, 'vcp-full-window', t),
              M.pub({ type: b.MSG.FullScreen, src: 'util', detail: { isFullscreen: h.__isFullscreen } }, h.player))
      }
      function d(e) {
      ...
      function f(e, t) {
        return 'undefined' == typeof t
          ? JSON.parse(localStorage[e] || 'null')
          : void (localStorage[e] = JSON.stringify(t))
      }
      function y(e, t) {
      ...
      if (L) for (var O = 0; O < L.length; O++) _[D[O]] = L[O]
      ;(t.CDNPath = 'https://cloudcache.tencent-cloud.com/open/qcloud/video/vcplayer/'),
        (t.VideoType = { RTMP: 'rtmp', FLV: 'flv', M3U8: 'm3u8' }),
        (t.console = {
          log: function () {
    ...
    function (e, t, i) {
      ...
      function l(e, t, i, o) {
        var s = n(o),
          a = r(o)
        return i.guid
          ? ((a[i.guid] = i), (s[e] = s[e] || {}), (s[e][i.guid] = s[e][i.guid] || []), s[e][i.guid].push(t), i)
          : console.error('callback function need guid')
      }
      function c(e, t, i, o) {
        var s = n(o),
          a = r(o)
    ...
    function (e, t, i) {
      ...
      var s = i(1),
        ...
        L = o(D)
      window.console ||
        (window.console = { log: function () {}, error: function () {}, debug: function () {}, info: function () {} })
      var C = (t.MSG = d.MSG),
        O = (t.browser = a),
        x = (t.util = p),
        P = (t.dom = c)
        ...
        function e(t) {
          ...
          return i
            ? ((this.guid = x.guid()),
              ...
              void this.render(i))
            : console.error('Player need a container')
        }
        return (
          (e.prototype.render = function (e) {
            var t = 'vcp-player'
            if (
              (O.TOUCH_ENABLED && (t += ' touchable'),
              (this.el = P.createEl('div', { class: t })),
            ...
            ;(this.poster = new S['default'](this)),
              ...
              (((O.IS_SAFARI && parseInt(O.SAFARI_VERSION) > 10) || O.IOS_VERSION > 10) &&
                'system' == this.options.controls) ||
                ((this.bigplay = new b['default'](this)), this.bigplay.render(this.el))
            var n = void 0
            ;(n = !(
              this.options.controls &&
              'default' != this.options.controls &&
              (!this.options.flash || 'system' != this.options.controls)
            )),
              n && ((this.panel = new g['default'](this)), this.panel.render(this.el)),
              this.setup()
          }),
          (e.prototype.verifyOptions = function () {
            return O.IE_VERSION && x.compareVersion(O.IE_VERSION, '8.0') == -1
              ? (this.errortips.show({ code: 5 }), !1)
              : !!this.options.src ||
                  (this.options.videoSource.hasUrl()
                    ? O.IS_IE || !O.IS_ENABLED_FLASH
            ...
            switch (e.type) {
              case C.Load:
                P.removeClass(this.el, 'vcp-playing'),
                  ('none' === this.options.preload ||
                    (this.options.hlsConfig && this.options.hlsConfig.autoStartLoad === !1)) &&
                    this.loading.hide()
                break
              case C.Play:
              ...
              case C.Error:
                ...
                try {
                  var i = this.options.videoSource,
                    o = x.getFormat(i)
                  O.IS_X5TBS ? MtaH5.clickStat('x5_err', { format: o }) : MtaH5.clickStat('error', { format: o })
                } catch (e) {}
            }
          ...
          (e.prototype.percent = function (e) {
            return this.video.duration()
              ? 'undefined' == typeof e
                ...
                : void this.video.currentTime(this.video.duration() * e)
              : 0
          }),
    ...
    function (e, t, i) {
      ;(t = e.exports = i(8)()),
        t.push([
          e.id,
          '.vcp-player{position:relative;z-index:0;font-family:Tahoma,\\\\5FAE\\8F6F\\96C5\\9ED1,\\u5b8b\\u4f53,Verdana,Arial,sans-serif;background-color:#000}.vcp-player video{display:block;overflow:hidden}.vcp-fullscreen.vcp-player,.vcp-fullscreen video,body.vcp-full-window{width:100%!important;height:100%!important}body.vcp-full-window{overflow-y:auto}.vcp-full-window .vcp-player{position:fixed;left:0;top:0;z-index:2147483647}.vcp-pre-flash,.vcp-video{width:100%;height:100%}.vcp-pre-flash{z-index:999;background:#000;position:absolute;top:0;left:0}.vcp-controls-panel{position:absolute;bottom:0;width:100%;font-size:16px;height:3em;z-index:1000}.vcp-controls-panel.show{animation:fadeIn ease .8s;animation-fill-mode:forwards;-webkit-animation-fill-mode:forwards}.vcp-controls-panel.hide{animation:fadeOut ease .8s;animation-fill-mode:forwards;-webkit-animation-fill-mode:forwards}.vcp-panel-bg{width:100%;height:100%;position:absolute;left:0;top:0;background-color:#242424;opacity:.8;filter:alpha(opacity=80);z-index:1000}.vcp-playtoggle{cursor:pointer;position:relative;z-index:1001;width:3em;height:100%;float:left;background-image:url(' +
            i(9) +
            ');background-image:url(' +
            i(10) +
            ')\\0}.vcp-playtoggle:focus,.vcp-playtoggle:hover{background-color:#708090;opacity:.9;filter:alpha(opacity=90)}.touchable .vcp-playtoggle:hover{background-color:transparent;opacity:1}.vcp-playing .vcp-playtoggle{background-image:url(' +
            i(11) +
            ');background-image:url(' +
            i(12) +
            ...
            ');background-image:url(' +
            i(14) +
            ')\\0;display:inline-block;width:3em;height:3em;position:absolute;left:0;top:0}.vcp-volume-muted .vcp-volume-icon{background-image:url(' +
            i(15) +
            ');background-image:url(' +
            i(16) +
            ')\\0}.vcp-volume .vcp-slider-vertical{top:-8.4em;left:1em;display:none}.vcp-volume .vcp-slider-track{position:absolute;bottom:0}.vcp-volume:hover .vcp-slider-vertical{display:block}.vcp-volume .vcp-volume-bg{height:8.8em;width:2em;position:absolute;left:.25em;top:-8.8em;background:#242424;display:none}.vcp-volume:hover .vcp-slider-vertical,.vcp-volume:hover .vcp-volume-bg{display:block}.vcp-fullscreen-toggle{position:relative;width:3em;height:3em;float:right;cursor:pointer;z-index:1001;background-image:url(' +
            i(17) +
            ');background-image:url(' +
            i(18) +
            ')\\0}.vcp-fullscreen .vcp-fullscreen-toggle{background-image:url(' +
            i(19) +
            ');background-image:url(' +
            i(20) +
            ')\\0}.vcp-loading{box-sizing:border-box;background-clip:padding-box;width:50px;height:50px;display:none;position:absolute;top:50%;left:50%;margin:-25px 0 0 -25px;text-indent:-9999em}.vcp-loading:before{box-sizing:inherit;content:"";display:block;width:100%;height:100%;border-radius:50%;border:3px solid hsla(0,0%,100%,0);border-left-color:#fff;border-right-color:#fff;transform:translateZ(0);animation:load8 1.1s infinite linear}@keyframes load8{0%{transform:rotate(0deg)}to{transform:rotate(1turn)}}.vcp-poster{position:absolute;left:0;top:0;overflow:hidden;z-index:1000;width:100%;height:100%;display:none}.vcp-poster-pic{position:relative}.vcp-poster-pic.cover,.vcp-poster-pic.default{left:50%;top:50%;transform:translate(-50%,-50%)}.vcp-poster-pic.cover{width:100%}.vcp-poster-pic.stretch{width:100%;height:100%}.vcp-error-tips{position:absolute;z-index:1001;width:100%;height:4.5em;left:0;top:50%;color:#ff4500;margin-top:-5.25em;text-align:center;display:none}.vcp-clarityswitcher{height:3em;width:3em;cursor:pointer;position:relative;z-index:1001;float:right;background-color:transparent;opacity:.9}.vcp-vertical-switcher-container{width:3em;position:absolute;left:0;bottom:2.4em;background:#242424;display:none}.vcp-vertical-switcher-current{display:block;color:#fff;text-align:center;line-height:3em}.vcp-vertical-switcher-item{display:block;color:#fff;text-align:center;line-height:2em}.vcp-vertical-switcher-item.current{color:#888}.vcp-share>a{width:3em;height:3em;cursor:pointer;background-image:url(' +
            i(21) +
          ...
          (e.i = function (t, i) {
            ...
            for (n = 0; n < t.length; n++) {
              ...
              ;('number' == typeof s[0] && o[s[0]]) ||
                (i && !s[2] ? (s[2] = i) : i && (s[2] = '(' + s[2] + ') and (' + i + ')'), e.push(s))
            }
          }),
          e
        )
    ...
    function (e, t, i) {
      ...
      function c(e, t) {
        ...
        if (t.singleton) {
          var r = m++
          ;(i = A || (A = a(t))), (o = u.bind(null, i, r, !1)), (n = u.bind(null, i, r, !0))
        } else
          e.sourceMap &&
          'function' == typeof URL &&
        ...
        b = (function (e) {
          ...
          return (
            ...
            (t.prototype.render = function (t) {
              ...
              return (
                (i =
                  o.poster && 'object' == l(o.poster) ? o.poster.src : 'string' == typeof o.poster ? o.poster : null),
                this.createEl('video', {
                  controls: n,
                  preload: o.preload || 'auto',
                  autoplay: r,
              ...
              if (n)
                switch (i) {
                  case Hls.ErrorTypes.NETWORK_ERROR:
                    o.indexOf('TimeOut') > 0
                      ? f.console.error('加载视频文件超时')
                      : f.console.error(
                          '无法加载视频文件，请检查网络，以及视频文件是否允许跨域请求访问，m3u8文件是否存在 ' +
                            (t.response && t.response.status ? 'netstatus:' + t.response.status : '')
                        ),
            ...
            (t.prototype.__webrtcLoaded = function (e) {
              ...
              var t = this,
                i = this.player.options.webrtcConfig,
                o = new TXLivePlayer()
              o.setPlayerView(this.el),
                i && i.streamType
                  ? 'video' === i.streamType
                    ? o.setConfig({ receiveVideo: !0, receiveAudio: !1 })
                    : 'audio' === i.streamType
                    ? o.setConfig({ receiveVideo: !1, receiveAudio: !0 })
                    : o.setConfig({ receiveVideo: !0, receiveAudio: !0 })
                  : o.setConfig({ receiveVideo: !0, receiveAudio: !0 }),
                o.startPlay(e),
                o.setPlayListener({
                  onPlayEvent: function (e, i) {
                    if (1006 === e) {
                      var o = { type: 'webrtcstop', timeStamp: +new Date() }
                      return t.notify(o), !1
                    }
                    if (1009 === e) {
                      var o = { type: 'webrtcwaitstart', timeStamp: +new Date() }
                      return t.notify(o), !1
                    }
                    if (1010 === e) {
                      var o = { type: 'webrtcwaitend', timeStamp: +new Date() }
                      return t.notify(o), !1
                    }
                    var o = { type: 'error' }
                    return (
                      ...
                      e === -2004 && (o.code = 2003),
                      e === -2005
                        ? (t.__convertProtocol(t.options.src, t.options.m3u8 ? f.VideoType.M3U8 : ''), !1)
                        : void (o.code && (i && (o.reason = i.message), (o.timeStamp = +new Date()), t.notify(o)))
                    )
                  },
                  onPlayStats: function (e) {
                    t.notify({ type: y.MSG.WebRTCStatUpdate, detail: e, timeStamp: +new Date() })
                  },
                }),
                (this.webrtc = o)
            }),
            (t.prototype.__flvLoaded = function (e) {
              ...
              var t = flvjs.createPlayer(
                Object.assign({ type: 'flv', isLive: this.player.options.live, url: e }, this.options.flvConfig)
              )
              t.attachMediaElement(this.el),
                t.on(
                  flvjs.Events.ERROR,
                  f.bind(this, function (e, t, i) {
                    var o = { type: 'error' }
                ...
                t.on(
                  flvjs.Events.MEDIA_INFO,
                  f.bind(this, function (e, t) {})
                ),
                t.on(
            ...
            (t.prototype.notify = function (e) {
              ...
              switch (e.type) {
                ...
                case y.MSG.Error:
                  ...
                  ;(t.detail = (this.el && this.el.error) || { code: e.code }),
                    (t.detail.reason = i[t.detail.code] || e.reason)
                  break
                case y.MSG.Ended:
                  this.pause(), (this.playState = A.PlayStates.STOP)
                  break
                case 'durationchange':
            ...
            (t.prototype.play = function () {
              this.options.hlsConfig &&
                this.options.hlsConfig.autoStartLoad === !1 &&
                this.hls &&
            ...
            (t.prototype.mute = function (e) {
              return 'undefined' == typeof e
                ? this.el.muted
                : (this.volume(e ? 0 : this.__lastVol), (this.el.muted = e))
            }),
            ...
            (t.prototype.load = function (e, t) {
              ...
              this.pub({ type: y.MSG.Load, src: this, ts: +new Date(), detail: { src: e, type: t } }),
                o
                  ? g.IS_ENABLED_WEBRTC.then(function (o) {
                      o
                        ? 'undefined' == typeof window.TXLivePlayer
                          ? h.loadScript(
                              f.unifyProtocol(
                                'https://cloudcache.tencent-cloud.com/open/qcloud/live/webrtc/js/TXLivePlayer-1.1.0.min.js'
                              ),
                              function () {
            ...
            (t.prototype.__convertProtocol = function (e, t) {
              g.IS_ENABLED_MSE
                ? g.IS_MOBILE
                  ? (e.indexOf('.sdp') > -1
                      ? (e = e.replace('.sdp', '.m3u8'))
                      : ((e = e.replace('webrtc://', 'https://').replace('?', '.m3u8?')),
                        e.indexOf('?') === -1 && e.indexOf('.m3u8') === -1 && (e += '.m3u8')),
                    this.__load(e, t))
                  : (e.indexOf('.sdp') > -1
                      ? (e = e.replace('.sdp', '.flv'))
                      : ((e = e.replace('webrtc://', 'https://').replace('?', '.flv?')),
                        e.indexOf('?') === -1 && e.indexOf('.flv') === -1 && (e += '.flv')),
                    this.__load(e, t))
                : this.notify({ type: 'error', code: 2e3, timeStamp: +new Date() })
            }),
            (t.prototype.__load = function (e, t) {
              ...
              if (
                !g.IS_ENABLED_MSE ||
                (!i && !o) ||
                (g.IS_X5TBS && this.player.options.x5_player) ||
                (i && g.IS_MAC && g.IS_SAFARI && !g.IS_IOS)
              )
                this.hls && (this.hls.stopLoad(), this.hls.detachMedia()),
                  this.flv && (this.flv.unload(), this.flv.detachMediaElement()),
                  (this.__type = t),
                ...
                i
                  ? ((this.__type = f.VideoType.M3U8),
                    'undefined' == typeof window.Hls
                      ? h.loadScript(f.unifyProtocol(f.CDNPath + r), function () {
                          n.__hlsLoaded.call(n, e)
                        })
                      : this.__hlsLoaded(e))
                  : o &&
                    ((this.__type = f.VideoType.FLV),
                    'undefined' == typeof window.flvjs
                      ? h.loadScript(f.unifyProtocol(f.CDNPath + 'libs/flv.min.1.5.js'), function () {
        ...
        y = (function () {
          ...
          return (
            ...
            (e.prototype.on = function (e, t, i) {
              ...
              return (
                n || a
                  ? ((i = u.bind(this, i, this.guid)), (this.fnCache[i.guid] = i), (o = i.guid))
                  : (i = this.fnCache[o]),
                l.on(e, t, i),
                (this.cbs[r(o, t)] = { guid: o, el: e, type: t }),
                i
              )
            }),
    ...
    function (e, t) {
      'use strict'
      t.__esModule = !0
      ;(t.PlayStates = { IDLE: 'IDLE', PLAYING: 'PLAYING', PAUSED: 'PAUSED', STOP: 'STOP' }),
        (t.SeekStates = { IDLE: 'IDLE', SEEKING: 'SEEKING', SEEKED: 'SEEKED' }),
    ...
    function (e, t, i) {
      ...
      function l(e) {
        return window.document[e]
          ...
          : document.embeds && document.embeds[e]
          ? document.embeds[e]
          : void 0
      }
      t.__esModule = !0
          ...
          return (
            ...
            (t.prototype.render = function (e) {
              ...
              var t = this.player.options,
                i = y.unifyProtocol(
                  t.flashUrl || '//cloudcache.tencent-cloud.com/open/qcloud/video/player/release/QCPlayer.swf'
                ),
                o = 'opaque',
              ...
              ;(s.innerHTML =
                '\n\t\t<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="" id="' +
                n +
                '" width="100%" height="100%">\n            <param name="movie"  value="' +
                i +
                '" />\n            <param name="quality" value="autohigh" />\n            <param name="swliveconnect" value="true" />\n            <param name="allowScriptAccess" value="always" />\n            <param name="bgcolor" value="#000" />\n            <param name="allowFullScreen" value="true" />\n            <param name="wmode" value="' +
                o +
                '" />\n            <param name="FlashVars" value="cbName=' +
                r +
                '" />\n\n            <embed src="' +
                i +
                ...
                (this.cover = d.createEl('div', { class: 'vcp-pre-flash' })),
            ...
            (t.prototype.doPolling = function () {
              this.options.live ||
                (clearInterval(this.__timer), (this.__timer = setInterval(this.interval.bind(this), 1e3)))
            }),
            ...
            (t.prototype.interval = function () {
              ...
              if (this.__m3u8) {
                ...
                this.__buffered !== t &&
                  ((this.__buffered = t), this.pub({ type: p.MSG.Progress, src: this, ts: +new Date() })),
                  this.__buffered >= this.duration() && this.endPolling()
              } else
                this.__rtmp ||
                  (this.__bytesloaded != e.bytesLoaded &&
                    ((this.__bytesloaded = e.bytesLoaded),
                    this.pub({ type: p.MSG.Progress, src: this, ts: +new Date() })),
            ...
            (t.prototype.notify = function (e, t) {
              ...
              try {
                switch (
                  (this.options.debug &&
                    this.pub({ type: i.type, src: this, ts: i.ts, detail: y.extend({ debug: !0 }, t) }),
                  i.type)
                ) {
                  case 'ready':
                  ...
                  case 'playState':
                    ;(this.playState = t.playState),
                      t.playState == A.PlayStates.PLAYING
                        ? ((this.__playing = !0), (this.__stopped = !1), (i.type = p.MSG.Play))
                        : t.playState == A.PlayStates.PAUSED
                        ? ((this.__playing = !1), (this.__stopped = !1), (i.type = p.MSG.Pause))
                        : t.playState == A.PlayStates.STOP
                        ? ((this.__playing = !1),
                          (this.__stopped = !0),
                          (i.type = p.MSG.Ended),
                          (this.__prevPlayState = null),
                          this.options.live && (this.metaDataLoaded = !1))
                        : t.playState == A.PlayStates.IDLE &&
                          ((this.__playing = !1), (this.__stopped = !0), (i.type = p.MSG.Ended))
                    break
                  case 'seekState':
                    ...
                    if (t.seekState == A.SeekStates.SEEKING) i.type = p.MSG.Seeking
                      ...
                      this.__m3u8 ||
                        this.options.live ||
                        t.playState != A.PlayStates.STOP ||
                        (this.play(), (this.__prevPlayState = t.playState)),
                        this.__m3u8 && (i.type = p.MSG.Seeked)
                    }
                    break
                  case 'netStatus':
                    this.options.live ||
                      ('NetStream.Buffer.Full' == t.code
                        ? (this.__prevPlayState == A.PlayStates.PAUSED || this.__prevPlayState == A.PlayStates.STOP,
                          (this.__prevPlayState = null),
                          (i.type = p.MSG.Seeked))
                        : 'NetStream.Seek.Complete' == t.code),
                      'NetConnection.Connect.Closed' == t.code &&
                        (this.options.src.indexOf('rtmp://') > -1
                          ? this.playState == A.PlayStates.STOP
                            ? ((i.type = 'error'), (t = { code: 13, reason: t.code }))
                            : ((i.type = 'error'), (t = { code: 1002, reason: t.code }))
                          : (this.playState = A.PlayStates.IDLE)),
                      ('NetStream.Play.Stop' != t.code &&
                        'NetConnection.Connect.Success' != t.code &&
                        'NetConnection.Connect.Failed' != t.code) ||
                        (this.playState = A.PlayStates.IDLE)
                    break
                  case 'mediaTime':
                    ;(this.__videoWidth = t.videoWidth),
                  ...
                  case 'error':
                    ...
                    'NetStream.Play.StreamNotFound' == t.code &&
                      this.pub({ type: 'netStatus', src: this, ts: i.ts, detail: t })
            ...
            (t.prototype.height = function (e) {
              return 'undefined' == typeof e
                ? this.el && this.el.height
                : ((e = '100%'), this.el && (this.el.height = e))
            }),
            (t.prototype.play = function (e) {
              this.playState == A.PlayStates.PAUSED || this.playState == A.PlayStates.PLAYING || e
                ? this.el.playerResume()
                : this.playState != A.PlayStates.PLAYING && this.el.playerPlay()
            }),
            (t.prototype.togglePlay = function () {
              if (this.metaDataLoaded)
                ...
                else if (this.playState == A.PlayStates.STOP) this.currentTime(0), this.el.playerResume()
                else
                  try {
                    this.el.playerPlay()
                  } catch (e) {
            ...
            (t.prototype.buffered = function () {
              ...
              return this.__m3u8
                ? this.__buffered || 0
                : ((e = (this.__bytesloaded || 0) / (this.__bytesTotal || 1)), this.duration() * e)
            }),
            (t.prototype.currentTime = function (e) {
            ...
            (t.prototype.volume = function (e) {
              return 'undefined' == typeof e
                ? this.el && this.el.getState().volume
                : (this.el && this.el.playerVolume(e),
                  0 != e && (this.__lastVol = e),
                  (this.options.volume = e),
                  void this.pub({ type: p.MSG.VolumeChange, src: this, ts: +new Date() }))
            }),
            (t.prototype.fullscreen = function (e) {
              return y.doFullscreen(this.player, e, this.owner)
            }),
            (t.prototype.load = function (e, t) {
              this.pub({ type: p.MSG.Load, src: this, ts: +new Date(), detail: { src: e, type: t } }),
          ...
          return (
            ...
            (t.prototype.render = function (t) {
              return (
                ...
                this.el.appendChild(E.createEl('div', { class: 'vcp-panel-bg' })),
                ...
                this.options.fullscreenEnabled === !0 &&
                  ((this.fullscreen = new d['default'](this.player)), this.fullscreen.render(this.el)),
                L.IS_MOBILE || ((this.volume = new w['default'](this.player)), this.volume.render(this.el)),
                this.options.videoSource &&
                  this.options.videoSource.definitions.length > 1 &&
                  !L.IS_MOBILE &&
              ...
              switch (e.type) {
                case S.MSG.MetaLoaded:
                  this.timeline.percent(this.player.percent()),
                    ...
                    this.player.volume('undefined' == typeof this.options.volume ? 0.5 : this.options.volume),
    ...
    function (e, t, i) {
      ...
      var l = i(24),
        ...
        h = i(4),
        d = (o(h), i(3)),
        f = (o(d), (t.MSG = { Changing: 'sliderchanging', Changed: 'sliderchanged' })),
        y = (function (e) {
          function t(i, o) {
            r(this, t)
          ...
          return (
            ...
            (t.prototype.render = function (t, i) {
              ...
              return (
                this.createEl('div', { class: o }),
                (this.track = p.createEl('div', { class: 'vcp-slider-track' })),
                (this.thumb = p.createEl('div', { class: 'vcp-slider-thumb' })),
            ...
            (t.prototype.mouseup = function (e) {
              ...
              this.off(this.ownerDoc, 'mouseup', this.mouseup),
                ...
                this.pub({ type: f.Changed, src: this, private: !0 })
            }),
            (t.prototype.mousemove = function (e) {
              var t = p.getPointerPosition(this.el, e, this.pos)
              this.vertical
                ? ((this.__percent = 1 - t.y), (this.thumb.style.top = 100 * this.__percent + '%'))
                : ((this.__percent = t.x), (this.thumb.style.left = 100 * this.__percent + '%')),
                (this.__percent = Number(this.__percent.toFixed(3))),
                this.pub({ type: f.Changing, src: this, private: !0 })
            }),
            (t.prototype.percent = function (e) {
              return e || 0 == e
                ? ((this.__percent = e),
                  void (this.vertical
                    ? (this.thumb.style.top = 100 * this.__percent + '%')
      ...
      var l = i(30),
        ...
        y = (function (e) {
          ...
          return (
            ...
            (t.prototype.setup = function () {
              this.enabled &&
                (this.sub(l.MSG.Changing, this.progress, f.bind(this, this.handleMsg)),
                this.sub(l.MSG.Changed, this.progress, f.bind(this, this.handleMsg)))
            }),
            (t.prototype.handleMsg = function (e) {
              e.type === l.MSG.Changing
                ? ((this.scrubbing = !0), this.syncLabel(this.percent()))
                : e.type === l.MSG.Changed && (this.scrubbing = !1)
            }),
            (t.prototype.syncLabel = function (e) {
              ...
              t && (i = f.convertTime(e * t) + ' / ' + f.convertTime(t)),
                this.pub({ type: 'timelabel', src: 'timeline', label: i, private: !0 })
            }),
          ...
          return (
            ...
            (t.prototype.render = function (t) {
              ;(this.show = !1),
                ...
                (this.current = p.createEl('a', { class: 'vcp-vertical-switcher-current' })),
                (this.container = p.createEl('div', { class: 'vcp-vertical-switcher-container' })),
                (this.items = []),
                (this.currentItem = '')
              var i = this.options.videoSource
        ...
        h = (function (e) {
          ...
          return (
            ...
            (t.prototype.onClick = function () {
              ...
              return p.IS_MOBILE && !e.paused()
                ? this.player.panel && this.player.panel.toggle()
      ...
      var l =
        ...
        m = (function (e) {
          function t(i) {
            ...
            return (
              o.options.poster && 'object' == l(o.options.poster)
                ? (o.poster = o.options.poster)
                : 'string' == typeof o.options.poster
                ? (o.poster = { src: o.options.poster })
                : (o.poster = {}),
              o
            )
          }
          return (
            ...
            (t.prototype.onClick = function () {
              this.pub({ type: 'click', src: this }),
                ((v.IS_SAFARI && parseInt(v.SAFARI_VERSION) > 10) || v.IOS_VERSION > 10) &&
                  'system' == this.player.options.controls &&
                  this.player.togglePlay()
            }),
            (t.prototype.handleMsg = function (e) {
              switch (e.type) {
        ...
        u = (function () {
          ...
          return (
            (e.prototype.load = function () {
              l.loadScript(
                (0, c.unifyProtocol)('//pingjs.qq.com/h5/stats.js?v2.0.4'),
                null,
                { name: 'MTAH5', sid: '500376528', cid: '500383222' },
                !0
              )
            }),
            (e.prototype.report = function () {
              window.MtaH5 &&
                (0 == this.player.duration() || this.player.duration() == 1 / 0
                  ? MtaH5.clickStat('live', { live: 'true' })
                  : MtaH5.clickStat('vod', { vod: 'true' }))
            }),
